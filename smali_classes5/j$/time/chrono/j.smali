...
.method B(Ljava/util/Map;Lj$/time/format/k;)Lj$/time/chrono/b;
    ...
    :goto_2
    invoke-virtual {p0, p1, p2, v0, v1}, Lj$/time/chrono/a;->k(Ljava/util/Map;Lj$/time/temporal/j;J)V
...
.method public F(III)Lj$/time/chrono/b;
    .locals 0

    .line 1
    invoke-static {p1, p2, p3}, Lj$/time/e;->c0(III)Lj$/time/e;
...
.method public I(I)Lj$/time/chrono/i;
    .locals 3
...
.method public M()Lj$/time/chrono/b;
    ...
    .line 2
    invoke-static {v0}, Lj$/time/e;->b0(Lj$/time/b;)Lj$/time/e;

    move-result-object v0

    .line 3
    invoke-static {v0}, Lj$/time/e;->q(Lj$/time/temporal/l;)Lj$/time/e;
...
.method public P(Lj$/time/chrono/i;I)I
    .locals 1
...
.method public R(Ljava/util/Map;Lj$/time/format/k;)Lj$/time/chrono/b;
    ...
    .line 1
    invoke-super {p0, p1, p2}, Lj$/time/chrono/a;->R(Ljava/util/Map;Lj$/time/format/k;)Lj$/time/chrono/b;
...
.method p(Ljava/util/Map;Lj$/time/format/k;)V
    ...
    invoke-virtual {p0, p1, p2, v2, v3}, Lj$/time/chrono/a;->k(Ljava/util/Map;Lj$/time/temporal/j;J)V
...
.method q(Ljava/util/Map;Lj$/time/format/k;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/e;->h0(J)Lj$/time/e;
    ...
    invoke-virtual {v1, v3, v4}, Lj$/time/temporal/j;->Y(J)I
    ...
    invoke-virtual {v3, v4, v5}, Lj$/time/temporal/j;->Y(J)I
    ...
    sget-object p2, Lj$/time/h;->FEBRUARY:Lj$/time/h;

    int-to-long v3, v0

    .line 2
    sget v5, Lj$/time/j;->a:I
    ...
    :cond_3
    :goto_0
    invoke-virtual {p2, v2}, Lj$/time/h;->p(Z)I
...
.method public u(Lj$/time/temporal/l;)Lj$/time/chrono/b;
    .locals 0
