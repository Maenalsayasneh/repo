...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v6, v7}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    invoke-virtual {v0, v5}, Lj$/time/format/c;->e(C)Lj$/time/format/c;

    sget-object v8, Lj$/time/temporal/j;->DAY_OF_MONTH:Lj$/time/temporal/j;

    invoke-virtual {v0, v8, v7}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v11, v12, v7}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v11, v14, v7}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v11, v15, v7}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v11, v13, v7, v5, v3}, Lj$/time/format/c;->b(Lj$/time/temporal/p;IIZ)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v1, v7, v4, v2}, Lj$/time/format/c;->q(Lj$/time/temporal/p;IILj$/time/format/l;)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v7, v11}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    sget-object v7, Lj$/time/temporal/k;->c:Lj$/time/temporal/p;

    const/4 v11, 0x4

    invoke-virtual {v0, v7, v11, v4, v2}, Lj$/time/format/c;->q(Lj$/time/temporal/p;IILj$/time/format/l;)Lj$/time/format/c;
    ...
    sget-object v2, Lj$/time/temporal/k;->b:Lj$/time/temporal/p;

    const/4 v4, 0x2

    invoke-virtual {v0, v2, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v2, v3}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v1, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    const/4 v4, 0x2

    invoke-virtual {v0, v6, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    invoke-virtual {v0, v8, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v3, v2, v0}, Lj$/time/format/c;->m(Lj$/time/temporal/p;Ljava/util/Map;)Lj$/time/format/c;
    ...
    invoke-virtual {v3, v8, v2, v4, v0}, Lj$/time/format/c;->q(Lj$/time/temporal/p;IILj$/time/format/l;)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v6, v10}, Lj$/time/format/c;->m(Lj$/time/temporal/p;Ljava/util/Map;)Lj$/time/format/c;

    invoke-virtual {v0, v2}, Lj$/time/format/c;->e(C)Lj$/time/format/c;

    const/4 v3, 0x4

    invoke-virtual {v0, v1, v3}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    invoke-virtual {v0, v2}, Lj$/time/format/c;->e(C)Lj$/time/format/c;

    invoke-virtual {v0, v12, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    const/16 v1, 0x3a

    invoke-virtual {v0, v1}, Lj$/time/format/c;->e(C)Lj$/time/format/c;

    invoke-virtual {v0, v14, v4}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
...
.method private g(Ljava/lang/CharSequence;Ljava/text/ParsePosition;)Lj$/time/temporal/l;
    .locals 4
    ...
    invoke-virtual {v3, v1, p1, v2}, Lj$/time/format/c$c;->o(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, p1, p2}, Lj$/time/format/d;->t(Lj$/time/format/k;Ljava/util/Set;)Lj$/time/temporal/l;
...
# virtual methods
.method public a(Lj$/time/temporal/l;)Ljava/lang/String;
    .locals 2
    ...
    invoke-direct {v1, p1, p0}, Lj$/time/format/g;-><init>(Lj$/time/temporal/l;Lj$/time/format/DateTimeFormatter;)V

    iget-object p1, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/c$c;

    invoke-virtual {p1, v1, v0}, Lj$/time/format/c$c;->k(Lj$/time/format/g;Ljava/lang/StringBuilder;)Z
    :try_end_0
...
.method public f(Ljava/lang/CharSequence;Lj$/time/temporal/r;)Ljava/lang/Object;
    .locals 5
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, Lj$/time/format/DateTimeFormatter;->g(Ljava/lang/CharSequence;Ljava/text/ParsePosition;)Lj$/time/temporal/l;

    move-result-object v0

    check-cast v0, Lj$/time/format/j;

    invoke-virtual {v0, p2}, Lj$/time/format/j;->d(Lj$/time/temporal/r;)Ljava/lang/Object;
