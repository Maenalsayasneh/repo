...
# virtual methods
.method public k(Lj$/time/format/g;Ljava/lang/StringBuilder;)Z
    .locals 18
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/g;->e(Lj$/time/temporal/p;)Ljava/lang/Long;

    move-result-object v1

    invoke-virtual/range {p1 .. p1}, Lj$/time/format/g;->d()Lj$/time/temporal/l;
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/l;->g(Lj$/time/temporal/p;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/j;->Y(J)I
    ...
    sget-object v2, Lj$/time/k;->d:Lj$/time/k;

    invoke-static {v5, v6, v3, v2}, Lj$/time/f;->e0(JILj$/time/k;)Lj$/time/f;
    ...
    invoke-virtual {v2}, Lj$/time/f;->V()I
    ...
    invoke-static {v12, v13, v3, v2}, Lj$/time/f;->e0(JILj$/time/k;)Lj$/time/f;
    ...
    invoke-virtual {v2}, Lj$/time/f;->Y()I
...
.method public o(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
    .locals 19
    ...
    invoke-virtual {v1, v2, v3}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v1, v5, v3}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;

    invoke-virtual {v1, v4}, Lj$/time/format/c;->e(C)Lj$/time/format/c;

    sget-object v4, Lj$/time/temporal/j;->SECOND_OF_MINUTE:Lj$/time/temporal/j;

    invoke-virtual {v1, v4, v3}, Lj$/time/format/c;->p(Lj$/time/temporal/p;I)Lj$/time/format/c;
    ...
    invoke-virtual {v1, v7, v3, v0, v8}, Lj$/time/format/c;->b(Lj$/time/temporal/p;IIZ)Lj$/time/format/c;
    ...
    invoke-virtual {v0, v1, v9, v6}, Lj$/time/format/c$c;->o(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v0}, Lj$/time/format/d;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v2}, Lj$/time/format/d;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v5}, Lj$/time/format/d;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v4}, Lj$/time/format/d;->j(Lj$/time/temporal/p;)Ljava/lang/Long;

    move-result-object v4

    invoke-virtual {v1, v7}, Lj$/time/format/d;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    :try_start_0
    invoke-static/range {v12 .. v18}, Lj$/time/f;->c0(IIIIIII)Lj$/time/f;

    move-result-object v0

    int-to-long v1, v3

    invoke-virtual {v0, v1, v2}, Lj$/time/f;->g0(J)Lj$/time/f;

    move-result-object v0

    sget-object v1, Lj$/time/k;->d:Lj$/time/k;
    ...
    invoke-virtual/range {v0 .. v5}, Lj$/time/format/d;->o(Lj$/time/temporal/p;JII)I
