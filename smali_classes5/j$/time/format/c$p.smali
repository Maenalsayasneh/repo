...
# direct methods
.method constructor <init>(Lj$/time/temporal/p;Lj$/time/format/m;Lj$/time/format/h;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;
...
.method private a()Lj$/time/format/c$i;
    ...
    iget-object v1, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;
    ...
    invoke-direct {v0, v1, v3, v4, v2}, Lj$/time/format/c$i;-><init>(Lj$/time/temporal/p;IILj$/time/format/l;)V
...
.method public k(Lj$/time/format/g;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;

    invoke-virtual {p1, v0}, Lj$/time/format/g;->e(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    :cond_0
    invoke-virtual {p1}, Lj$/time/format/g;->d()Lj$/time/temporal/l;
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/l;->d(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;
    ...
    :cond_3
    :goto_0
    invoke-virtual/range {v3 .. v8}, Lj$/time/format/h;->d(Lj$/time/temporal/p;JLj$/time/format/m;Ljava/util/Locale;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/h;->d(Lj$/time/temporal/p;JLj$/time/format/m;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/c$i;->k(Lj$/time/format/g;Ljava/lang/StringBuilder;)Z
...
.method public o(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v2, v0, v3}, Lj$/time/format/h;->e(Lj$/time/temporal/p;Lj$/time/format/m;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    iget-object v5, p0, Lj$/time/format/c$p;->a:Lj$/time/temporal/p;
    ...
    :cond_2
    invoke-virtual {v4, v5, v0, v6}, Lj$/time/format/h;->e(Lj$/time/temporal/p;Lj$/time/format/m;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual/range {v4 .. v9}, Lj$/time/format/d;->o(Lj$/time/temporal/p;JII)I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/format/c$i;->o(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
