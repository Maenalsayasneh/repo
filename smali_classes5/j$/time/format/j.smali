...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lj$/time/format/j;->h:Lj$/time/i;
...
.method private o(Lj$/time/temporal/l;)V
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/l;->f(Lj$/time/temporal/p;)Z
...
.method private q()V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lj$/time/format/j;->r(Lj$/time/ZoneId;)V
...
.method private r(Lj$/time/ZoneId;)V
    ...
    invoke-interface {v2, v0, p1}, Lj$/time/chrono/h;->x(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/f;

    move-result-object p1

    invoke-interface {p1}, Lj$/time/chrono/f;->n()Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {p0, v0}, Lj$/time/format/j;->w(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {p1}, Lj$/time/g;->h0()I
    ...
    invoke-direct {p0, v1, v0, p1}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
...
.method private s(JJJJ)V
    ...
    invoke-static {p1, p2}, Lj$/time/g;->b0(J)Lj$/time/g;

    move-result-object p1

    invoke-static {p5}, Lj$/time/i;->d(I)Lj$/time/i;

    move-result-object p2

    :goto_0
    invoke-direct {p0, p1, p2}, Lj$/time/format/j;->u(Lj$/time/g;Lj$/time/i;)V
    ...
    invoke-virtual {v0, p3, p4}, Lj$/time/temporal/j;->Y(J)I

    move-result p3

    sget-object p4, Lj$/time/temporal/j;->NANO_OF_SECOND:Lj$/time/temporal/j;

    invoke-virtual {p4, p7, p8}, Lj$/time/temporal/j;->Y(J)I
    ...
    sget-object p1, Lj$/time/g;->c:Lj$/time/g;
    ...
    invoke-virtual {p7, p1, p2}, Lj$/time/temporal/j;->Y(J)I

    move-result p1

    sget-object p2, Lj$/time/temporal/j;->SECOND_OF_MINUTE:Lj$/time/temporal/j;

    invoke-virtual {p2, p5, p6}, Lj$/time/temporal/j;->Y(J)I

    move-result p2

    invoke-static {p1, p3, p2, p4}, Lj$/time/g;->a0(IIII)Lj$/time/g;
...
.method private t()V
    ...
    :cond_0
    invoke-virtual {v1, v4, v5}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v1, v0, v4}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    :cond_4
    invoke-virtual {v1, v6, v7}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v1, v0, v2}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-virtual {v2, v6, v7}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v1, v0, v6}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v0, v8}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-virtual {v1, v8, v9}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v1, v0, v10}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-virtual {v1, v2, v3}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-virtual {v9, v10, v11}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v9, v1, v0}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-virtual {v6, v9, v10}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {p0, v6, v1, v0}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v5 .. v13}, Lj$/time/format/j;->s(JJJJ)V

    :cond_19
    return-void
.end method

.method private u(Lj$/time/g;Lj$/time/i;)V
    .locals 3

    iget-object v0, p0, Lj$/time/format/j;->g:Lj$/time/g;
    ...
    iget-object p1, p0, Lj$/time/format/j;->h:Lj$/time/i;
    ...
    iget-object v2, p0, Lj$/time/format/j;->h:Lj$/time/i;
    ...
    iget-object v2, p0, Lj$/time/format/j;->g:Lj$/time/g;
    ...
    :cond_2
    iput-object p1, p0, Lj$/time/format/j;->g:Lj$/time/g;

    :cond_3
    :goto_0
    iput-object p2, p0, Lj$/time/format/j;->h:Lj$/time/i;

    return-void
.end method

.method private w(Lj$/time/chrono/b;)V
    .locals 3
...
.method private x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    .locals 5
...
.method public d(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lj$/time/format/j;->g:Lj$/time/g;
...
.method public f(Lj$/time/temporal/p;)Z
    ...
    invoke-virtual {v0, p1}, Lj$/time/g;->f(Lj$/time/temporal/p;)Z
...
.method p(Lj$/time/format/k;Ljava/util/Set;)Lj$/time/temporal/l;
    .locals 18
    ...
    .line 1
    invoke-direct/range {p0 .. p0}, Lj$/time/format/j;->q()V
    ...
    invoke-interface {v0, v1, v2}, Lj$/time/chrono/h;->R(Ljava/util/Map;Lj$/time/format/k;)Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {v9, v0}, Lj$/time/format/j;->w(Lj$/time/chrono/b;)V

    .line 3
    invoke-direct/range {p0 .. p0}, Lj$/time/format/j;->t()V
    ...
    invoke-interface {v3, v4, v9, v5}, Lj$/time/temporal/p;->P(Ljava/util/Map;Lj$/time/temporal/l;Lj$/time/format/k;)Lj$/time/temporal/l;
    ...
    invoke-interface {v4}, Lj$/time/chrono/f;->T()Lj$/time/ZoneId;
    ...
    :goto_1
    invoke-interface {v4}, Lj$/time/chrono/f;->z()Lj$/time/chrono/d;
    ...
    invoke-interface {v4}, Lj$/time/chrono/d;->m()Lj$/time/g;

    move-result-object v1

    sget-object v2, Lj$/time/i;->a:Lj$/time/i;

    invoke-direct {v9, v1, v2}, Lj$/time/format/j;->u(Lj$/time/g;Lj$/time/i;)V

    invoke-interface {v4}, Lj$/time/chrono/d;->n()Lj$/time/chrono/b;

    move-result-object v1

    invoke-direct {v9, v1}, Lj$/time/format/j;->w(Lj$/time/chrono/b;)V
    ...
    invoke-direct {v9, v4}, Lj$/time/format/j;->w(Lj$/time/chrono/b;)V

    goto :goto_3

    :cond_6
    instance-of v1, v4, Lj$/time/g;

    if-eqz v1, :cond_7

    check-cast v4, Lj$/time/g;

    sget-object v1, Lj$/time/i;->a:Lj$/time/i;

    invoke-direct {v9, v4, v1}, Lj$/time/format/j;->u(Lj$/time/g;Lj$/time/i;)V
    ...
    :cond_b
    :goto_4
    iget-object v0, v9, Lj$/time/format/j;->g:Lj$/time/g;
    ...
    invoke-direct {v9, v3, v6, v2}, Lj$/time/format/j;->x(Lj$/time/temporal/p;Lj$/time/temporal/p;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v8}, Lj$/time/format/j;->s(JJJJ)V
    ...
    invoke-interface {v2}, Lj$/time/temporal/p;->k()Z
    ...
    invoke-virtual {v2, v3, v4}, Lj$/time/temporal/j;->Z(J)J
    ...
    invoke-direct {v9, v0}, Lj$/time/format/j;->o(Lj$/time/temporal/l;)V
    ...
    iget-object v1, v9, Lj$/time/format/j;->g:Lj$/time/g;
    ...
    iget-object v0, v9, Lj$/time/format/j;->h:Lj$/time/i;
    ...
    iget-object v1, v9, Lj$/time/format/j;->h:Lj$/time/i;

    invoke-interface {v0, v1}, Lj$/time/chrono/b;->N(Lj$/time/temporal/o;)Lj$/time/chrono/b;
    ...
    iput-object v0, v9, Lj$/time/format/j;->h:Lj$/time/i;
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/d;->H(Lj$/time/ZoneId;)Lj$/time/chrono/f;
    ...
    iget-object v2, v9, Lj$/time/format/j;->g:Lj$/time/g;

    invoke-interface {v1, v2}, Lj$/time/chrono/b;->L(Lj$/time/g;)Lj$/time/chrono/d;

    move-result-object v1

    invoke-interface {v1, v0}, Lj$/time/chrono/d;->H(Lj$/time/ZoneId;)Lj$/time/chrono/f;
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/f;->g(Lj$/time/temporal/p;)J
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lj$/time/format/j;->g:Lj$/time/g;
