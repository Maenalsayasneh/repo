...
# static fields
.field static final g:Lj$/time/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/c$m;->g:Lj$/time/e;

    return-void
.end method

.method constructor <init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lj$/time/format/c$m;-><init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;I)V
...
.method private constructor <init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;I)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/c$i;-><init>(Lj$/time/temporal/p;IILj$/time/format/l;I)V
...
.method synthetic constructor <init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;ILj$/time/format/c$a;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lj$/time/format/c$m;-><init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;I)V
...
.method b(Lj$/time/format/g;J)J
    ...
    invoke-interface {p1, v2}, Lj$/time/chrono/h;->u(Lj$/time/temporal/l;)Lj$/time/chrono/b;

    move-result-object p1

    iget-object v2, p0, Lj$/time/format/c$i;->b:Lj$/time/temporal/p;
...
.method d(Lj$/time/format/d;JII)I
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/h;->u(Lj$/time/temporal/l;)Lj$/time/chrono/b;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/c$i;->b:Lj$/time/temporal/p;

    invoke-interface {v0, v1}, Lj$/time/temporal/l;->j(Lj$/time/temporal/p;)I
...
.method e()Lj$/time/format/c$i;
    ...
    iget-object v3, p0, Lj$/time/format/c$i;->b:Lj$/time/temporal/p;
    ...
    invoke-direct/range {v2 .. v8}, Lj$/time/format/c$m;-><init>(Lj$/time/temporal/p;IIILj$/time/chrono/b;I)V
