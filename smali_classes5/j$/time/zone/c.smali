...
.field private static final c:[Lj$/time/f;
...
.field private final f:[Lj$/time/k;

.field private final g:[J

.field private final h:[Lj$/time/f;

.field private final i:[Lj$/time/k;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lj$/time/zone/c;->c:[Lj$/time/f;
...
.method private constructor <init>(Lj$/time/k;)V
    .locals 2
    ...
    iput-object v0, p0, Lj$/time/zone/c;->f:[Lj$/time/k;
    ...
    sget-object p1, Lj$/time/zone/c;->c:[Lj$/time/f;

    iput-object p1, p0, Lj$/time/zone/c;->h:[Lj$/time/f;

    iput-object v0, p0, Lj$/time/zone/c;->i:[Lj$/time/k;
...
.method constructor <init>(Ljava/util/TimeZone;)V
    ...
    invoke-static {v1}, Lj$/time/zone/c;->k(I)Lj$/time/k;
    ...
    sget-object v1, Lj$/time/zone/c;->c:[Lj$/time/f;

    iput-object v1, p0, Lj$/time/zone/c;->h:[Lj$/time/f;
...
.method private a(Lj$/time/f;Lj$/time/zone/a;)Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lj$/time/zone/a;->o()Lj$/time/f;

    move-result-object v0

    invoke-virtual {p2}, Lj$/time/zone/a;->P()Z

    move-result v1

    invoke-virtual {p1, v0}, Lj$/time/f;->a0(Lj$/time/chrono/d;)Z
    ...
    invoke-virtual {p2}, Lj$/time/zone/a;->B()Lj$/time/k;
    ...
    :cond_0
    invoke-virtual {p2}, Lj$/time/zone/a;->k()Lj$/time/f;
...
.method private b(I)[Lj$/time/zone/a;
    ...
    invoke-static {v3, v6, v7, v5, v5}, Lj$/time/f;->b0(IIIII)Lj$/time/f;

    move-result-object v3

    iget-object v6, v0, Lj$/time/zone/c;->f:[Lj$/time/k;

    aget-object v5, v6, v5

    invoke-interface {v3, v5}, Lj$/time/chrono/d;->X(Lj$/time/k;)J
    ...
    :goto_3
    invoke-static {v3}, Lj$/time/zone/c;->k(I)Lj$/time/k;
    ...
    invoke-static {v4}, Lj$/time/zone/c;->k(I)Lj$/time/k;

    move-result-object v7

    invoke-direct {v0, v5, v6, v7}, Lj$/time/zone/c;->c(JLj$/time/k;)I
    ...
    invoke-direct {v12, v5, v6, v3, v7}, Lj$/time/zone/a;-><init>(JLj$/time/k;Lj$/time/k;)V
...
.method private c(JLj$/time/k;)I
    ...
    invoke-virtual {p1}, Lj$/time/e;->Z()I
...
.method private e(Lj$/time/f;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lj$/time/f;->Y()I
    ...
    iget-object v1, p0, Lj$/time/zone/c;->f:[Lj$/time/k;

    aget-object v1, v1, v2

    invoke-interface {p1, v1}, Lj$/time/chrono/d;->X(Lj$/time/k;)J
    ...
    invoke-static {p1}, Lj$/time/zone/c;->k(I)Lj$/time/k;
    ...
    invoke-virtual {v1}, Lj$/time/zone/a;->B()Lj$/time/k;
    ...
    iget-object p1, p0, Lj$/time/zone/c;->f:[Lj$/time/k;
    ...
    iget-object v0, p0, Lj$/time/zone/c;->h:[Lj$/time/f;
    ...
    invoke-virtual {p1, v0}, Lj$/time/f;->Z(Lj$/time/chrono/d;)Z
    ...
    iget-object p1, p0, Lj$/time/zone/c;->i:[Lj$/time/k;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->i:[Lj$/time/k;
    ...
    invoke-virtual {v3}, Lj$/time/k;->V()I
    ...
    invoke-direct {v0, v1, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/f;Lj$/time/k;Lj$/time/k;)V
    ...
    invoke-direct {v1, v0, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/f;Lj$/time/k;Lj$/time/k;)V

    return-object v1

    :cond_e
    iget-object v0, p0, Lj$/time/zone/c;->i:[Lj$/time/k;
...
.method public static j(Lj$/time/k;)Lj$/time/zone/c;
    .locals 1

    new-instance v0, Lj$/time/zone/c;

    invoke-direct {v0, p0}, Lj$/time/zone/c;-><init>(Lj$/time/k;)V

    return-object v0
.end method

.method private static k(I)Lj$/time/k;
    .locals 0

    div-int/lit16 p0, p0, 0x3e8

    invoke-static {p0}, Lj$/time/k;->a0(I)Lj$/time/k;
...
# virtual methods
.method public d(Lj$/time/Instant;)Lj$/time/k;
    .locals 6
    ...
    invoke-direct {p0, v2, v3, p1}, Lj$/time/zone/c;->c(JLj$/time/k;)I
    ...
    invoke-virtual {v0}, Lj$/time/zone/a;->Q()J
    ...
    invoke-virtual {v0}, Lj$/time/zone/a;->B()Lj$/time/k;
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/a;->q()Lj$/time/k;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lj$/time/zone/c;->f:[Lj$/time/k;
    ...
    iget-object v1, p0, Lj$/time/zone/c;->i:[Lj$/time/k;

    iget-object v3, p1, Lj$/time/zone/c;->i:[Lj$/time/k;
...
.method public h(Lj$/time/Instant;)Z
    ...
    invoke-static {v0}, Lj$/time/zone/c;->k(I)Lj$/time/k;
    ...
    iget-object v0, p0, Lj$/time/zone/c;->f:[Lj$/time/k;
    ...
    .line 2
    :goto_0
    invoke-virtual {p0, p1}, Lj$/time/zone/c;->d(Lj$/time/Instant;)Lj$/time/k;
...
.method public i()Z
    ...
    invoke-virtual {v1}, Lj$/time/Instant;->B()I
    ...
    invoke-direct {v0, v10, v11, v1}, Lj$/time/zone/c;->c(JLj$/time/k;)I
    ...
    invoke-virtual {v6}, Lj$/time/zone/a;->Q()J
    ...
    invoke-static {v4, v3, v3}, Lj$/time/e;->c0(III)Lj$/time/e;

    move-result-object v4

    invoke-virtual {v4}, Lj$/time/e;->v()J
    ...
    invoke-direct {v0, v5, v6, v1}, Lj$/time/zone/c;->c(JLj$/time/k;)I
    ...
    iget-object v1, v0, Lj$/time/zone/c;->i:[Lj$/time/k;
    ...
    invoke-virtual {v12}, Lj$/time/zone/a;->Q()J
    ...
    :cond_d
    invoke-direct {v0, v4, v5, v1}, Lj$/time/zone/c;->c(JLj$/time/k;)I
    ...
    iget-object v4, v0, Lj$/time/zone/c;->i:[Lj$/time/k;

    aget-object v5, v4, v5

    aget-object v1, v4, v1

    invoke-direct {v9, v6, v7, v5, v1}, Lj$/time/zone/a;-><init>(JLj$/time/k;Lj$/time/k;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->f:[Lj$/time/k;
