...
.method public static B(Ljava/lang/String;Lj$/time/k;)Lj$/time/ZoneId;
    .locals 2
    ...
    invoke-virtual {p1}, Lj$/time/k;->t()Ljava/lang/String;
    ...
    .line 2
    invoke-direct {v0, p0, p1}, Lj$/time/l;-><init>(Ljava/lang/String;Lj$/time/zone/c;)V

    return-object v0
.end method

.method private static I(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    .locals 3
    ...
    sget-object p0, Lj$/time/k;->d:Lj$/time/k;

    invoke-static {v0, p0}, Lj$/time/ZoneId;->B(Ljava/lang/String;Lj$/time/k;)Lj$/time/ZoneId;
    ...
    invoke-static {p0, p2}, Lj$/time/l;->P(Ljava/lang/String;Z)Lj$/time/l;
    ...
    invoke-static {p1}, Lj$/time/k;->Y(Ljava/lang/String;)Lj$/time/k;

    move-result-object p1

    sget-object p2, Lj$/time/k;->d:Lj$/time/k;

    if-ne p1, p2, :cond_2

    invoke-static {v0, p1}, Lj$/time/ZoneId;->B(Ljava/lang/String;Lj$/time/k;)Lj$/time/ZoneId;
...
.method public static o(Lj$/time/temporal/l;)Lj$/time/ZoneId;
    .locals 3
...
.method public static q(Ljava/lang/String;)Lj$/time/ZoneId;
    ...
    :cond_2
    invoke-static {p0, v1}, Lj$/time/l;->P(Ljava/lang/String;Z)Lj$/time/l;
    ...
    :goto_1
    invoke-static {p0, v0, v1}, Lj$/time/ZoneId;->I(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, Lj$/time/k;->Y(Ljava/lang/String;)Lj$/time/k;
