...
.field private cipher:Ls0/a/b/x;
...
# direct methods
.method public constructor <init>(Ls0/a/b/x;I)V
    .locals 1

    const/4 v0, -0x1

    invoke-direct {p0, p1, p2, v0, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Ls0/a/b/x;III)V

    return-void
.end method

.method public constructor <init>(Ls0/a/b/x;II)V
    .locals 1

    const/4 v0, -0x1

    invoke-direct {p0, p1, p2, p3, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Ls0/a/b/x;III)V

    return-void
.end method

.method public constructor <init>(Ls0/a/b/x;III)V
    .locals 4
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Ls0/a/b/x;
...
.method public engineDoFinal([BII[BI)I
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Ls0/a/b/x;
    ...
    invoke-interface/range {v2 .. v7}, Ls0/a/b/x;->processBytes([BII[BI)I

    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Ls0/a/b/x;

    invoke-interface {p1}, Ls0/a/b/x;->reset()V
...
.method public engineDoFinal([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Ls0/a/b/x;

    invoke-interface {p2}, Ls0/a/b/x;->reset()V
...
.method public engineGetIV()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Ls0/a/b/k0/c1;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Ls0/a/b/x;

    invoke-interface {v0}, Ls0/a/b/x;->getAlgorithmName()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Ls0/a/b/k0/c1;
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-interface {p2}, Ls0/a/b/x;->getAlgorithmName()Ljava/lang/String;

    move-result-object v9

    invoke-static/range {v3 .. v9}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Ls0/a/b/i;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getOID()Ls0/a/a/n;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Ls0/a/b/k0/c1;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Ls0/a/b/k0/c1;
    ...
    iput-object p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Ls0/a/b/k0/c1;
    ...
    invoke-interface {p1, v2, p2}, Ls0/a/b/x;->init(ZLs0/a/b/i;)V
    ...
    invoke-interface {p1, v1, p2}, Ls0/a/b/x;->init(ZLs0/a/b/i;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public engineUpdate([BII)[B
    ...
    invoke-interface/range {v0 .. v5}, Ls0/a/b/x;->processBytes([BII[BI)I
