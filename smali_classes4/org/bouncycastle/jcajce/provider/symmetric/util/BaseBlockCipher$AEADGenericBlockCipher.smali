...
# instance fields
.field private cipher:Ls0/a/b/i0/b;
...
.method public constructor <init>(Ls0/a/b/i0/b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Ls0/a/b/i0/b;

    return-void
.end method

.method public static synthetic access$000(Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;)Ls0/a/b/i0/b;
    .locals 0

    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Ls0/a/b/i0/b;
...
.method public doFinal([BI)I
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Ls0/a/b/i0/b;

    invoke-interface {v0, p1, p2}, Ls0/a/b/i0/b;->doFinal([BI)I
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    instance-of v1, v0, Ls0/a/b/i0/a;

    if-eqz v1, :cond_0

    check-cast v0, Ls0/a/b/i0/a;

    invoke-interface {v0}, Ls0/a/b/i0/a;->getUnderlyingCipher()Ls0/a/b/e;
    ...
    :cond_0
    invoke-interface {v0}, Ls0/a/b/i0/b;->getAlgorithmName()Ljava/lang/String;
...
.method public getOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Ls0/a/b/i0/b;->getOutputSize(I)I
...
.method public getUpdateOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Ls0/a/b/i0/b;->getUpdateOutputSize(I)I
...
.method public init(ZLs0/a/b/i;)V
    ...
    invoke-interface {v0, p1, p2}, Ls0/a/b/i0/b;->init(ZLs0/a/b/i;)V
...
.method public processByte(B[BI)I
    ...
    invoke-interface {v0, p1, p2, p3}, Ls0/a/b/i0/b;->processByte(B[BI)I
...
.method public processBytes([BII[BI)I
    ...
    invoke-interface/range {v0 .. v5}, Ls0/a/b/i0/b;->processBytes([BII[BI)I
...
.method public updateAAD([BII)V
    ...
    invoke-interface {v0, p1, p2, p3}, Ls0/a/b/i0/b;->b([BII)V
