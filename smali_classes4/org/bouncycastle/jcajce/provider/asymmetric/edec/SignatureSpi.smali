...
.field private signer:Ls0/a/b/v;
...
.method private getSigner(Ljava/lang/String;)Ls0/a/b/v;
    .locals 2
    ...
    new-instance p1, Ls0/a/b/n0/j;

    sget-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->EMPTY_CONTEXT:[B

    invoke-direct {p1, v0}, Ls0/a/b/n0/j;-><init>([B)V

    return-object p1

    :cond_2
    new-instance p1, Ls0/a/b/n0/i;

    invoke-direct {p1}, Ls0/a/b/n0/i;-><init>()V
...
.method public engineInitSign(Ljava/security/PrivateKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->engineGetKeyParameters()Ls0/a/b/k0/b;

    move-result-object p1

    instance-of v0, p1, Ls0/a/b/k0/h0;
    ...
    :goto_0
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->getSigner(Ljava/lang/String;)Ls0/a/b/v;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->signer:Ls0/a/b/v;

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/SignatureSpi;->signer:Ls0/a/b/v;

    const/4 v1, 0x1

    invoke-interface {v0, v1, p1}, Ls0/a/b/v;->init(ZLs0/a/b/i;)V
...
.method public engineInitVerify(Ljava/security/PublicKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->engineGetKeyParameters()Ls0/a/b/k0/b;

    move-result-object p1

    instance-of v0, p1, Ls0/a/b/k0/i0;
...
.method public engineSign()[B
    ...
    invoke-interface {v0}, Ls0/a/b/v;->b()[B
...
.method public engineUpdate(B)V
    ...
    invoke-interface {v0, p1}, Ls0/a/b/v;->update(B)V
...
.method public engineUpdate([BII)V
    ...
    invoke-interface {v0, p1, p2, p3}, Ls0/a/b/v;->update([BII)V
...
.method public engineVerify([B)Z
    ...
    invoke-interface {v0, p1}, Ls0/a/b/v;->a([B)Z
