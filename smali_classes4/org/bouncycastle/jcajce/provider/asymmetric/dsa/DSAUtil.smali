...
# static fields
.field public static final dsaOids:[Ls0/a/a/n;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->dsaOids:[Ls0/a/a/n;
...
.method public static generateKeyFingerprint(Ljava/math/BigInteger;Ljava/security/interfaces/DSAParams;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, p1}, Ls0/a/e/b/b0/c/h3;->T([B[B[B[B)[B
...
.method public static generatePrivateKeyParameter(Ljava/security/PrivateKey;)Ls0/a/b/k0/b;
    ...
    invoke-direct {v2, v3, v4, p0}, Ls0/a/b/k0/p;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, v2}, Ls0/a/b/k0/q;-><init>(Ljava/math/BigInteger;Ls0/a/b/k0/p;)V
...
.method public static generatePublicKeyParameter(Ljava/security/PublicKey;)Ls0/a/b/k0/b;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()Ls0/a/b/k0/r;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()Ls0/a/b/k0/r;
    ...
    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Ls0/a/a/c3/m0;)V

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()Ls0/a/b/k0/r;
...
.method public static isDsaOid(Ls0/a/a/n;)Z
    .locals 4
    ...
    :goto_0
    sget-object v2, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->dsaOids:[Ls0/a/a/n;
...
.method public static toDSAParameters(Ljava/security/interfaces/DSAParams;)Ls0/a/b/k0/p;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, Ls0/a/b/k0/p;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
