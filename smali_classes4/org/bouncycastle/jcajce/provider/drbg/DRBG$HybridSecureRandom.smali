...
.method public constructor <init>()V
    ...
    invoke-static {v4}, Ls0/a/g/j;->c(Ljava/lang/String;)[B
    ...
    .line 2
    new-instance v5, Ls0/a/b/h0/g;

    new-instance v6, Ls0/a/b/b0/a0;

    invoke-direct {v6}, Ls0/a/b/b0/a0;-><init>()V

    invoke-direct {v5, v6}, Ls0/a/b/h0/g;-><init>(Ls0/a/b/n;)V
    ...
    invoke-interface {v3, v7}, Ls0/a/b/m0/d;->get(I)Ls0/a/b/m0/c;

    move-result-object v3

    new-instance v8, Ls0/a/b/m0/e$a;

    invoke-direct {v8, v5, v0, v4, v7}, Ls0/a/b/m0/e$a;-><init>(Ls0/a/b/s;[B[BI)V

    invoke-direct {v6, v1, v3, v8, v2}, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;-><init>(Ljava/security/SecureRandom;Ls0/a/b/m0/c;Ls0/a/b/m0/b;Z)V
...
.method public generateSeed(I)[B
    ...
    :try_start_0
    iget-object v2, v0, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;->y:Ls0/a/b/m0/f/c;

    if-nez v2, :cond_0

    iget-object v2, v0, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;->c:Ls0/a/b/m0/b;

    iget-object v3, v0, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;->x:Ls0/a/b/m0/c;

    invoke-interface {v2, v3}, Ls0/a/b/m0/b;->a(Ls0/a/b/m0/c;)Ls0/a/b/m0/f/c;

    move-result-object v2

    iput-object v2, v0, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;->y:Ls0/a/b/m0/f/c;

    :cond_0
    iget-object v2, v0, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;->y:Ls0/a/b/m0/f/c;

    invoke-interface {v2, v1}, Ls0/a/b/m0/f/c;->a([B)V
