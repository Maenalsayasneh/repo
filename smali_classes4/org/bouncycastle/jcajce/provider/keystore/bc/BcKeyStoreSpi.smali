...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ls0/a/c/o/c;
...
.method private decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ls0/a/c/o/c;

    invoke-interface {p1, v0}, Ls0/a/c/o/c;->e(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-static {v0, v1, v4}, Li0/d/a/a/a;->o0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ls0/a/c/o/c;

    invoke-interface {v0, v2}, Ls0/a/c/o/c;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_7
    invoke-static {v3}, Ls0/a/a/w2/p;->s(Ljava/lang/Object;)Ls0/a/a/w2/p;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance v4, Ls0/a/b/h0/g;

    new-instance v5, Ls0/a/b/b0/v;

    invoke-direct {v5}, Ls0/a/b/b0/v;-><init>()V

    invoke-direct {v4, v5}, Ls0/a/b/h0/g;-><init>(Ls0/a/b/n;)V
    ...
    new-instance v5, Ls0/a/b/f0/t;

    new-instance v6, Ls0/a/b/b0/v;

    invoke-direct {v6}, Ls0/a/b/b0/v;-><init>()V

    invoke-direct {v5, v6}, Ls0/a/b/f0/t;-><init>(Ls0/a/b/n;)V

    invoke-virtual {v5, p2, v2, v3}, Ls0/a/b/t;->init([B[BI)V

    if-eq p1, v1, :cond_3

    .line 1
    iget p1, v4, Ls0/a/b/h0/g;->c:I
    ...
    .line 2
    :goto_1
    invoke-virtual {v5, p1}, Ls0/a/b/f0/t;->generateDerivedMacParameters(I)Ls0/a/b/i;
    ...
    .line 4
    invoke-virtual {v4, p1}, Ls0/a/b/h0/g;->init(Ls0/a/b/i;)V

    new-instance p1, Ls0/a/b/g0/c;

    invoke-direct {p1, v0, v4}, Ls0/a/b/g0/c;-><init>(Ljava/io/InputStream;Ls0/a/b/s;)V
    ...
    invoke-virtual {v4, p1, v1}, Ls0/a/b/h0/g;->doFinal([BI)I

    .line 7
    iget p2, v4, Ls0/a/b/h0/g;->c:I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    new-instance p1, Ls0/a/b/h0/g;

    new-instance v3, Ls0/a/b/b0/v;

    invoke-direct {v3}, Ls0/a/b/b0/v;-><init>()V

    invoke-direct {p1, v3}, Ls0/a/b/h0/g;-><init>(Ls0/a/b/n;)V

    new-instance v3, Ls0/a/b/g0/d;

    invoke-direct {v3, p1}, Ls0/a/b/g0/d;-><init>(Ls0/a/b/s;)V

    new-instance v4, Ls0/a/b/f0/t;

    new-instance v5, Ls0/a/b/b0/v;

    invoke-direct {v5}, Ls0/a/b/b0/v;-><init>()V

    invoke-direct {v4, v5}, Ls0/a/b/f0/t;-><init>(Ls0/a/b/n;)V

    invoke-static {p2}, Ls0/a/b/t;->PKCS12PasswordToBytes([C)[B

    move-result-object p2

    invoke-virtual {v4, p2, v1, v2}, Ls0/a/b/t;->init([B[BI)V
    ...
    .line 2
    :goto_0
    invoke-virtual {v4, v1}, Ls0/a/b/f0/t;->generateDerivedMacParameters(I)Ls0/a/b/i;

    move-result-object v1

    invoke-virtual {p1, v1}, Ls0/a/b/h0/g;->init(Ls0/a/b/i;)V
    ...
    :cond_1
    new-instance p2, Ls0/a/g/l/b;

    invoke-direct {p2, v0, v3}, Ls0/a/g/l/b;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->saveStore(Ljava/io/OutputStream;)V

    .line 3
    iget p2, p1, Ls0/a/b/h0/g;->c:I

    .line 4
    new-array p2, p2, [B

    invoke-virtual {p1, p2, v1}, Ls0/a/b/h0/g;->doFinal([BI)I
...
.method public makePBECipher(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ls0/a/c/o/c;

    invoke-interface {p3, p1}, Ls0/a/c/o/c;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:Ls0/a/c/o/c;

    invoke-interface {p4, p1}, Ls0/a/c/o/c;->c(Ljava/lang/String;)Ljavax/crypto/Cipher;
