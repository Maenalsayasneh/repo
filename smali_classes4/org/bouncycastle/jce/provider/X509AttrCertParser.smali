...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ls0/a/a/v;
...
.method private getCertificate()Ls0/a/h/h;
    .locals 3
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ls0/a/a/v;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ls0/a/a/v;
    ...
    invoke-direct {v1, v0}, Ls0/a/h/q;-><init>([B)V
...
.method private readDERCertificate(Ljava/io/InputStream;)Ls0/a/h/h;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ls0/a/a/v;

    invoke-direct {p0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->getCertificate()Ls0/a/h/h;
    ...
    :cond_0
    new-instance v0, Ls0/a/h/q;

    invoke-virtual {p1}, Ls0/a/a/m;->getEncoded()[B

    move-result-object p1

    invoke-direct {v0, p1}, Ls0/a/h/q;-><init>([B)V

    return-object v0
.end method

.method private readPEMCertificate(Ljava/io/InputStream;)Ls0/a/h/h;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public engineRead()Ljava/lang/Object;
    ...
    :cond_0
    iput-object v1, p0, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->sData:Ls0/a/a/v;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->readPEMCertificate(Ljava/io/InputStream;)Ls0/a/h/h;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509AttrCertParser;->readDERCertificate(Ljava/io/InputStream;)Ls0/a/h/h;
