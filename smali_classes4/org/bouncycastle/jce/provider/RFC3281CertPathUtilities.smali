...
.method public static constructor <clinit>()V
    ...
    sget-object v0, Ls0/a/a/c3/u;->m2:Ls0/a/a/n;
...
.method public static additionalChecks(Ls0/a/h/h;Ljava/util/Set;Ljava/util/Set;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Ls0/a/h/h;->b(Ljava/lang/String;)[Ls0/a/h/f;
    ...
    invoke-static {p1, v0, v1}, Li0/d/a/a/a;->o0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p0, p2}, Ls0/a/h/h;->b(Ljava/lang/String;)[Ls0/a/h/f;
    ...
    invoke-static {p1, p2, v1}, Li0/d/a/a/a;->o0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static checkCRL(Ls0/a/a/c3/s;Ls0/a/h/h;Ls0/a/c/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Ls0/a/c/o/c;)V
    .locals 23
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v0, Ls0/a/a/c3/w0;->c:Ls0/a/a/n;
    ...
    invoke-direct/range {v2 .. v8}, Ls0/a/c/g;-><init>(Ls0/a/c/k;Ljava/util/Date;Ljava/security/cert/CertPath;ILjava/security/cert/X509Certificate;Ljava/security/PublicKey;)V

    invoke-static {v0, v1, v9, v10, v11}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCompleteCRLs(Ls0/a/c/g;Ls0/a/a/c3/s;Ljava/lang/Object;Ls0/a/c/k;Ljava/util/Date;)Ljava/util/Set;
    ...
    .line 3
    iget-boolean v4, v10, Ls0/a/c/k;->c2:Z
    ...
    .line 5
    iget-object v5, v10, Ls0/a/c/k;->Z1:Ljava/util/List;
    :try_end_1
    ...
    .line 6
    :try_start_2
    invoke-static {v6, v3, v4, v5, v7}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Ls0/a/c/o/c;)Ljava/util/Set;
    ...
    .line 8
    invoke-interface/range {p1 .. p1}, Ls0/a/h/h;->getNotAfter()Ljava/util/Date;
    ...
    :cond_4
    :goto_2
    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB1(Ls0/a/a/c3/s;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB2(Ls0/a/a/c3/s;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v3, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Ls0/a/c/k;)V

    invoke-static {v11, v2, v9, v12, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLI(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;Ls0/a/c/k;)V
...
.method public static checkCRLs(Ls0/a/h/h;Ls0/a/c/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Ls0/a/c/o/c;)V
    .locals 20
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    .line 1
    iget-boolean v1, v0, Ls0/a/c/k;->b2:Z
    ...
    invoke-static {v11, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ls0/a/a/r;

    move-result-object v1

    invoke-static {v1}, Ls0/a/a/c3/k;->t(Ljava/lang/Object;)Ls0/a/a/c3/k;
    ...
    .line 3
    :try_start_1
    iget-object v3, v0, Ls0/a/c/k;->a2:Ljava/util/Map;
    ...
    .line 4
    invoke-static {v1, v3, v12, v13}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAdditionalStoresFromCRLDistributionPoint(Ls0/a/a/c3/k;Ljava/util/Map;Ljava/util/Date;Ls0/a/c/o/c;)Ljava/util/List;
    ...
    new-instance v3, Ls0/a/c/k$b;

    invoke-direct {v3, v0}, Ls0/a/c/k$b;-><init>(Ls0/a/c/k;)V
    ...
    check-cast v4, Ls0/a/c/d;

    .line 5
    iget-object v5, v3, Ls0/a/c/k$b;->g:Ljava/util/List;
    ...
    .line 6
    :cond_0
    invoke-virtual {v3}, Ls0/a/c/k$b;->a()Ls0/a/c/k;
    ...
    :try_start_2
    invoke-virtual {v1}, Ls0/a/a/c3/k;->s()[Ls0/a/a/c3/s;
    ...
    :try_start_4
    invoke-static/range {v1 .. v10}, Lorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->checkCRL(Ls0/a/a/c3/s;Ls0/a/h/h;Ls0/a/c/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Ls0/a/c/o/c;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ls0/a/a/b3/c;
    ...
    :try_start_6
    new-instance v2, Ls0/a/a/c3/s;

    new-instance v3, Ls0/a/a/c3/t;

    new-instance v4, Ls0/a/a/c3/x;

    new-instance v5, Ls0/a/a/c3/w;

    const/4 v6, 0x4

    invoke-direct {v5, v6, v1}, Ls0/a/a/c3/w;-><init>(ILs0/a/a/e;)V

    invoke-direct {v4, v5}, Ls0/a/a/c3/x;-><init>(Ls0/a/a/c3/w;)V

    const/4 v1, 0x0

    invoke-direct {v3, v1, v4}, Ls0/a/a/c3/t;-><init>(ILs0/a/a/e;)V

    const/4 v1, 0x0

    invoke-direct {v2, v3, v1, v1}, Ls0/a/a/c3/s;-><init>(Ls0/a/a/c3/t;Ls0/a/a/c3/k0;Ls0/a/a/c3/x;)V
...
.method public static processAttrCert1(Ls0/a/h/h;Ls0/a/c/k;)Ljava/security/cert/CertPath;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p0}, Ls0/a/h/h;->a()Ls0/a/h/a;

    move-result-object v2

    .line 1
    iget-object v3, v2, Ls0/a/h/a;->c:Ls0/a/a/c3/z;

    .line 2
    iget-object v3, v3, Ls0/a/a/c3/z;->c:Ls0/a/a/c3/a0;
    ...
    .line 3
    iget-object v3, v3, Ls0/a/a/c3/a0;->c:Ls0/a/a/c3/x;

    .line 4
    invoke-virtual {v2, v3}, Ls0/a/h/a;->c(Ls0/a/a/c3/x;)[Ljava/security/Principal;
    ...
    invoke-virtual {v7}, Ls0/a/h/a;->d()Ljava/math/BigInteger;
    ...
    .line 6
    iget-object v8, v7, Ls0/a/h/a;->c:Ls0/a/a/c3/z;

    .line 7
    iget-object v8, v8, Ls0/a/a/c3/z;->c:Ls0/a/a/c3/a0;

    if-eqz v8, :cond_1

    .line 8
    iget-object v8, v8, Ls0/a/a/c3/a0;->c:Ls0/a/a/c3/x;

    .line 9
    invoke-virtual {v7, v8}, Ls0/a/h/a;->c(Ls0/a/a/c3/x;)[Ljava/security/Principal;
    ...
    .line 12
    new-instance v10, Ls0/a/c/i;

    invoke-direct {v10, v9, v4}, Ls0/a/c/i;-><init>(Ljava/security/cert/CertSelector;Ls0/a/c/i$a;)V

    .line 13
    invoke-virtual {p1}, Ls0/a/c/k;->b()Ljava/util/List;

    move-result-object v9

    invoke-static {v1, v10, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ls0/a/c/i;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-direct {p1, v5, p0}, Lorg/bouncycastle/jce/exception/ExtCertPathValidatorException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2}, Ls0/a/h/a;->b()[Ljava/security/Principal;

    move-result-object v2

    if-eqz v2, :cond_9

    new-instance v2, Ls0/a/h/k;

    invoke-direct {v2}, Ls0/a/h/k;-><init>()V

    invoke-interface {p0}, Ls0/a/h/h;->a()Ls0/a/h/a;

    move-result-object p0

    invoke-virtual {p0}, Ls0/a/h/a;->b()[Ljava/security/Principal;
    ...
    .line 14
    :cond_6
    invoke-virtual {v2}, Ls0/a/h/k;->clone()Ljava/lang/Object;
    ...
    invoke-direct {v8, v7, v4}, Ls0/a/c/i;-><init>(Ljava/security/cert/CertSelector;Ls0/a/c/i$a;)V
    ...
    invoke-static {v1, v8, v7}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;Ls0/a/c/i;Ljava/util/List;)V
    :try_end_1
    ...
    :cond_9
    :goto_5
    new-instance p0, Ls0/a/c/k$b;

    invoke-direct {p0, p1}, Ls0/a/c/k$b;-><init>(Ls0/a/c/k;)V
    ...
    new-instance v3, Ls0/a/h/k;

    invoke-direct {v3}, Ls0/a/h/k;-><init>()V
    ...
    .line 17
    invoke-virtual {v3}, Ls0/a/h/k;->clone()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ljava/security/cert/CertSelector;

    .line 18
    new-instance v5, Ls0/a/c/i;

    invoke-direct {v5, v3, v4}, Ls0/a/c/i;-><init>(Ljava/security/cert/CertSelector;Ls0/a/c/i$a;)V

    .line 19
    iput-object v5, p0, Ls0/a/c/k$b;->d:Ls0/a/c/i;
    ...
    .line 20
    invoke-static {v3, v5}, Ljava/security/cert/CertPathBuilder;->getInstance(Ljava/lang/String;Ljava/lang/String;)Ljava/security/cert/CertPathBuilder;
    ...
    invoke-virtual {p0}, Ls0/a/c/k$b;->a()Ls0/a/c/k;
    ...
    invoke-virtual {v3, v5}, Ljava/security/cert/CertPathBuilder;->build(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v3, v5, v1}, Lorg/bouncycastle/jce/exception/ExtCertPathValidatorException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static processAttrCert2(Ljava/security/cert/CertPath;Ls0/a/c/k;)Ljava/security/cert/CertPathValidatorResult;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static processAttrCert3(Ljava/security/cert/X509Certificate;Ls0/a/c/k;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static processAttrCert5(Ls0/a/h/h;Ljava/util/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-interface {p0, p1}, Ls0/a/h/h;->checkValidity(Ljava/util/Date;)V
    :try_end_0
...
.method public static processAttrCert7(Ls0/a/h/h;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ls0/a/c/k;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-static {p0, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Ls0/a/a/r;

    move-result-object v2

    invoke-static {v2}, Ls0/a/a/c3/r0;->s(Ljava/lang/Object;)Ls0/a/a/c3/r0;
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    check-cast p4, Ls0/a/h/e;

    invoke-virtual {p4, p0, p1, p2, v0}, Ls0/a/h/e;->b(Ls0/a/h/h;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ljava/util/Collection;)V
