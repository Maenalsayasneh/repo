...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILt0/h;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lt0/r$k;->a:Ljava/lang/reflect/Method;

    .line 3
    iput p2, p0, Lt0/r$k;->b:I

    .line 4
    iput-boolean p4, p0, Lt0/r$k;->c:Z
...
.method public a(Lt0/t;Ljava/lang/Object;)V
    ...
    .line 6
    iget-boolean v1, p0, Lt0/r$k;->c:Z

    invoke-virtual {p1, v2, v4, v1}, Lt0/t;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    goto :goto_0

    .line 7
    :cond_0
    iget-object p1, p0, Lt0/r$k;->a:Ljava/lang/reflect/Method;

    iget p2, p0, Lt0/r$k;->b:I
