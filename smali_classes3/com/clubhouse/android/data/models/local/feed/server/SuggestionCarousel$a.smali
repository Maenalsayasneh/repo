.class public final Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;
.end annotation
...
# static fields
.field public static final a:Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;

    invoke-direct {v0}, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;-><init>()V

    sput-object v0, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;->a:Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;

    .line 1
    new-instance v1, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;

    const-string v2, "com.clubhouse.android.data.models.local.feed.server.SuggestionCarousel"
    ...
    sput-object v1, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    .line 2
    sget-object v0, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    invoke-interface {p1, v0, v2, v6, v3}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v12, Lcom/clubhouse/android/data/models/local/club/ClubWithAdmin$a;->a:Lcom/clubhouse/android/data/models/local/club/ClubWithAdmin$a;
    ...
    invoke-interface {p1, v0, v5, v11, v9}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, v4, v11, v8}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;-><init>(ILjava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method public serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;
    ...
    :cond_0
    iget-object v2, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->c:Ljava/lang/String;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->c:Ljava/lang/String;
    ...
    :cond_3
    iget-object v2, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->d:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->d:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->q:Ljava/util/List;
    ...
    iget-object v5, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->q:Ljava/util/List;
    ...
    :cond_9
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->x:Ljava/util/List;
    ...
    iget-object p2, p2, Lcom/clubhouse/android/data/models/local/feed/server/SuggestionCarousel;->x:Ljava/util/List;
