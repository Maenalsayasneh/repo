.class public final Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;
.end annotation
...
# static fields
.field public static final a:Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;

    invoke-direct {v0}, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;-><init>()V

    sput-object v0, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;->a:Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;

    .line 1
    new-instance v1, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;

    const-string v2, "com.clubhouse.android.data.models.local.feed.server.FeedTopicsUpsell"
    ...
    sput-object v1, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    .line 2
    sget-object v0, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v7, Lcom/clubhouse/android/data/models/local/Topic$a;->a:Lcom/clubhouse/android/data/models/local/Topic$a;

    invoke-direct {v6, v7}, Ln0/c/k/e;-><init>(Lkotlinx/serialization/KSerializer;)V

    invoke-interface {p1, v0, v4, v6, v2}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    new-instance v6, Ln0/c/k/h0;

    sget-object v7, Li0/e/b/b3/a/b/c/a;->a:Li0/e/b/b3/a/b/c/a;

    invoke-direct {v6, v1, v7}, Ln0/c/k/h0;-><init>(Lkotlinx/serialization/KSerializer;Lkotlinx/serialization/KSerializer;)V

    invoke-interface {p1, v0, v5, v6, v2}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, v4, v9, v1}, Ln0/c/j/c;->v(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v2, v3, v4, v1}, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;-><init>(ILjava/lang/String;Ljava/util/List;Ljava/util/Map;)V
...
.method public serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;
    ...
    :cond_0
    iget-object v2, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->c:Ljava/lang/String;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->c:Ljava/lang/String;
    ...
    :cond_3
    iget-object v2, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->d:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->d:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->q:Ljava/util/Map;
    ...
    iget-object p2, p2, Lcom/clubhouse/android/data/models/local/feed/server/FeedTopicsUpsell;->q:Ljava/util/Map;
