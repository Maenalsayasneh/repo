.class public final Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/clubhouse/android/data/models/remote/request/OnboardingState;
.end annotation
...
# static fields
.field public static final a:Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;

    invoke-direct {v0}, Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;-><init>()V

    sput-object v0, Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;->a:Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;

    .line 1
    new-instance v1, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;

    const-string v2, "com.clubhouse.android.data.models.remote.request.OnboardingState"

    const/4 v3, 0x4

    invoke-direct {v1, v2, v0, v3}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;-><init>(Ljava/lang/String;Ln0/c/k/v;I)V

    const-string v0, "screens_seen"

    const/4 v2, 0x1

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;->i(Ljava/lang/String;Z)V

    const-string v0, "topic_ids_selected"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;->i(Ljava/lang/String;Z)V

    const-string v0, "club_ids_followed"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;->i(Ljava/lang/String;Z)V

    const-string v0, "user_ids_followed"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;->i(Ljava/lang/String;Z)V

    sput-object v1, Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    .line 2
    sget-object v0, Lcom/clubhouse/android/data/models/remote/request/OnboardingState$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    invoke-direct {v4, v7}, Ln0/c/k/e;-><init>(Lkotlinx/serialization/KSerializer;)V
    ...
    invoke-direct {v5, v7}, Ln0/c/k/e;-><init>(Lkotlinx/serialization/KSerializer;)V

    invoke-interface {p1, v0, v6, v5, v3}, Ln0/c/j/c;->m(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    new-instance v6, Ln0/c/k/e;

    invoke-direct {v6, v7}, Ln0/c/k/e;-><init>(Lkotlinx/serialization/KSerializer;)V

    invoke-interface {p1, v0, v2, v6, v3}, Ln0/c/j/c;->m(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, v2, v11, v7}, Ln0/c/j/c;->m(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, v6, v11, v1}, Ln0/c/j/c;->m(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/b;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;-><init>(ILjava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method public serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;
    ...
    :cond_0
    iget-object v2, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->a:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->a:Ljava/util/List;
    ...
    :cond_3
    iget-object v2, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->b:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->b:Ljava/util/List;

    invoke-interface {p1, v0, v3, v2, v4}, Ln0/c/j/d;->z(Lkotlinx/serialization/descriptors/SerialDescriptor;ILn0/c/f;Ljava/lang/Object;)V
    ...
    :cond_6
    iget-object v4, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->c:Ljava/util/List;
    ...
    iget-object v5, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->c:Ljava/util/List;
    ...
    :cond_9
    iget-object v4, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->d:Ljava/util/List;
    ...
    iget-object p2, p2, Lcom/clubhouse/android/data/models/remote/request/OnboardingState;->d:Ljava/util/List;
