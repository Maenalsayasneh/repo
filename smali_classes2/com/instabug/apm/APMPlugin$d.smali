...
.method public constructor <init>(Li0/j/a/h/b/a;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/instabug/apm/APMPlugin$d;->c:Li0/j/a/h/b/a;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/apm/APMPlugin$d;->c:Li0/j/a/h/b/a;
    ...
    .line 3
    iget-object v2, v1, Li0/j/a/d/a/b/d;->b:Lcom/instabug/library/internal/storage/cache/db/DatabaseManager;
    ...
    .line 6
    invoke-virtual {v1, v2, v5}, Li0/j/a/d/a/b/d;->b(Lcom/instabug/library/internal/storage/cache/db/SQLiteDatabaseWrapper;Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    check-cast v5, Li0/j/a/d/b/c;

    .line 9
    iget-object v5, v5, Li0/j/a/d/b/c;->b:Ljava/lang/String;

    if-eqz v5, :cond_0

    .line 10
    iget-object v6, v1, Li0/j/a/d/a/b/d;->c:Li0/j/a/n/a/a;

    invoke-virtual {v4, v3, v5}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v6, v5}, Li0/j/a/n/a/a;->f(Ljava/lang/String;)V
    ...
    .line 13
    iget-object v1, v0, Li0/j/a/d/a/b/b;->a:Lcom/instabug/library/internal/storage/cache/db/DatabaseManager;
    ...
    .line 14
    invoke-virtual {v0, v1}, Li0/j/a/d/a/b/b;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    check-cast v2, Li0/j/a/d/b/c;

    .line 16
    iget-object v2, v2, Li0/j/a/d/b/c;->b:Ljava/lang/String;

    if-eqz v2, :cond_3

    .line 17
    iget-object v5, v0, Li0/j/a/d/a/b/b;->b:Li0/j/a/n/a/a;

    invoke-virtual {v4, v3, v2}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v2}, Li0/j/a/n/a/a;->f(Ljava/lang/String;)V
