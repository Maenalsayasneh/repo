...
# instance fields
.field private final apmLogger:Li0/j/a/n/a/a;
...
.field private final sessionHandler:Li0/j/a/h/d/c;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/instabug/apm/APMPlugin;->sessionHandler:Li0/j/a/h/d/c;
    ...
    iput-object v0, p0, Lcom/instabug/apm/APMPlugin;->apmLogger:Li0/j/a/n/a/a;

    return-void
.end method

.method public static synthetic access$000(Lcom/instabug/apm/APMPlugin;)Li0/j/a/n/a/a;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/instabug/apm/APMPlugin;->apmLogger:Li0/j/a/n/a/a;
...
.method public static synthetic access$800(Lcom/instabug/apm/APMPlugin;)Li0/j/a/h/d/c;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/instabug/apm/APMPlugin;->sessionHandler:Li0/j/a/h/d/c;
...
.method private clearInvalidCache()V
    ...
    .line 2
    new-instance v1, Li0/j/a/h/c/c;

    invoke-direct {v1}, Li0/j/a/h/c/c;-><init>()V

    const-string v2, "execution_traces_thread_executor"

    .line 3
    invoke-static {v2}, Li0/j/a/g/a;->f(Ljava/lang/String;)Ljava/util/concurrent/Executor;

    move-result-object v2

    new-instance v3, Lcom/instabug/apm/APMPlugin$d;

    invoke-direct {v3, v0}, Lcom/instabug/apm/APMPlugin$d;-><init>(Li0/j/a/h/b/a;)V
    ...
    invoke-direct {v2, v1}, Lcom/instabug/apm/APMPlugin$e;-><init>(Li0/j/a/h/c/a;)V
...
.method private endSession()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/apm/APMPlugin;->sessionHandler:Li0/j/a/h/d/c;
...
.method private purgeData()V
    ...
    .line 3
    iget-object v0, v0, Li0/j/a/e/c;->b:Landroid/content/SharedPreferences$Editor;
    ...
    invoke-direct {v3, v0, v1}, Lcom/instabug/apm/APMPlugin$b;-><init>(Li0/j/a/k/a;Z)V
...
.method private registerActivityLifeCycleCallbacks()V
    ...
    .line 3
    sget-boolean v1, Li0/j/a/i/a;->c:Z
    ...
    new-instance v2, Li0/j/a/i/a;

    .line 5
    sget-object v3, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    invoke-direct {v2, v0, v3}, Li0/j/a/i/a;-><init>(Landroid/content/Context;Ljava/lang/Boolean;)V
...
.method private registerConfigurationChange()V
    ...
    invoke-static {v1}, Lcom/instabug/library/core/eventbus/coreeventbus/SDKCoreEventSubscriber;->subscribe(Lk0/b/y/d;)Lk0/b/w/a;
...
.method private registerSessionCrashHandler()V
    ...
    instance-of v0, v0, Li0/j/a/h/d/b;

    if-nez v0, :cond_0

    .line 3
    new-instance v0, Li0/j/a/h/d/b;

    invoke-direct {v0}, Li0/j/a/h/d/b;-><init>()V
...
.method private startSession(Lcom/instabug/library/model/common/Session;)V
    ...
    .line 2
    iget-object v1, v0, Li0/j/a/h/d/d;->a:Li0/j/a/e/b;

    check-cast v1, Li0/j/a/e/c;

    invoke-virtual {v1}, Li0/j/a/e/c;->a()Z
    ...
    iget-object v1, v0, Li0/j/a/h/d/d;->e:Ljava/lang/Runnable;

    if-nez v1, :cond_0

    .line 3
    new-instance v1, Li0/j/a/h/d/e;

    invoke-direct {v1, v0, p1}, Li0/j/a/h/d/e;-><init>(Li0/j/a/h/d/d;Lcom/instabug/library/model/common/Session;)V

    .line 4
    iput-object v1, v0, Li0/j/a/h/d/d;->e:Ljava/lang/Runnable;

    .line 5
    iget-object p1, v0, Li0/j/a/h/d/d;->a:Li0/j/a/e/b;

    check-cast p1, Li0/j/a/e/c;

    invoke-virtual {p1}, Li0/j/a/e/c;->a()Z
    ...
    .line 6
    iget-object p1, v0, Li0/j/a/h/d/d;->e:Ljava/lang/Runnable;
...
.method private stopRunningMetrics()V
    ...
    .line 6
    new-instance v3, Li0/j/a/h/b/b;

    invoke-direct {v3, v0}, Li0/j/a/h/b/b;-><init>(Li0/j/a/h/b/c;)V
    ...
    invoke-direct {v2, v1}, Li0/j/a/h/c/b;-><init>(Li0/j/a/h/c/c;)V
...
.method private subscribeToSDKState()V
    ...
    .line 4
    sget-object v3, Lk0/b/z/b/a;->e:Lk0/b/y/d;
...
.method public wake()V
    ...
    .line 5
    :cond_0
    iget-object v0, p0, Lcom/instabug/apm/APMPlugin;->apmLogger:Li0/j/a/n/a/a;

    const-string v1, "APM session not created. Core session is null"

    invoke-virtual {v0, v1}, Li0/j/a/n/a/a;->f(Ljava/lang/String;)V
