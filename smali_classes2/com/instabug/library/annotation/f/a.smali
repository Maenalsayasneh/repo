...
.method public constructor <init>(Landroid/graphics/PointF;Landroid/graphics/PointF;IF)V
    ...
    iput-object v0, p0, Lcom/instabug/library/annotation/f/a;->x:Landroid/graphics/Paint;
    ...
    .line 6
    iput-object p1, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;

    .line 7
    iput-object p2, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;
...
.method public a(Lcom/instabug/library/annotation/b;)Landroid/graphics/Path;
    ...
    .line 2
    iget-object v0, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;

    iget v1, v0, Landroid/graphics/PointF;->x:F

    iget v0, v0, Landroid/graphics/PointF;->y:F

    iget-object v2, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;
    ...
    .line 3
    invoke-static {v1, v0, v3, v2}, Li0/j/c/l/a;->b(FFFF)F
    ...
    .line 4
    iget-object v2, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;

    const/high16 v3, 0x42700000    # 60.0f

    invoke-static {v3, v1, v2}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {v3, v0, v2}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 8
    iget-object v2, p0, Lcom/instabug/library/annotation/f/a;->a2:Ljava/lang/String;
    ...
    .line 10
    iget-object v1, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;
...
.method public c(Landroid/graphics/Canvas;Lcom/instabug/library/annotation/b;Lcom/instabug/library/annotation/b;)V
    ...
    .line 2
    iget-object p3, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;
    ...
    :cond_3
    :goto_1
    iget-object p3, p2, Lcom/instabug/library/annotation/b;->q:Lcom/instabug/library/annotation/b$a;

    if-ne p3, v0, :cond_4

    .line 10
    iget-object p3, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;
    ...
    :cond_5
    :goto_2
    iget-object p3, p2, Lcom/instabug/library/annotation/b;->x:Lcom/instabug/library/annotation/b$b;
    ...
    iget-object p3, p0, Lcom/instabug/library/annotation/f/a;->x:Landroid/graphics/Paint;
...
.method public d(Landroid/graphics/Canvas;Lcom/instabug/library/annotation/b;[Li0/j/e/b/b;)V
    ...
    .line 1
    iget-object p2, p0, Lcom/instabug/library/annotation/f/a;->x:Landroid/graphics/Paint;
    ...
    .line 3
    iput-object v2, v1, Li0/j/e/b/b;->b:Landroid/graphics/PointF;
    ...
    .line 7
    iput p2, v1, Li0/j/e/b/b;->c:I

    .line 8
    aget-object v1, p3, v0

    invoke-virtual {v1, p1}, Li0/j/e/b/b;->b(Landroid/graphics/Canvas;)V
...
.method public g(Landroid/graphics/PointF;Lcom/instabug/library/annotation/b;)Z
    ...
    .line 2
    iget-object p2, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;

    iget v0, p2, Landroid/graphics/PointF;->x:F

    iget p2, p2, Landroid/graphics/PointF;->y:F

    iget-object v1, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;
    ...
    .line 3
    invoke-static {v0, p2, v2, v1}, Li0/j/c/l/a;->b(FFFF)F
    ...
    invoke-static {v2, v0, v1}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 5
    iget-object v3, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;

    invoke-static {v2, p2, v3}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v3

    .line 6
    iget-object v4, p0, Lcom/instabug/library/annotation/f/a;->Y1:Landroid/graphics/PointF;

    invoke-static {v2, p2, v4}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {v2, v0, v4}, Li0/j/c/l/a;->j(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;
...
.method public final h(Lcom/instabug/library/annotation/b;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/library/annotation/f/a;->y:Landroid/graphics/PointF;
    ...
    iput-object v1, p1, Lcom/instabug/library/annotation/b;->c:Lcom/instabug/library/annotation/b$a;

    .line 5
    sget-object v1, Lcom/instabug/library/annotation/b$a;->RIGHT:Lcom/instabug/library/annotation/b$a;

    iput-object v1, p1, Lcom/instabug/library/annotation/b;->q:Lcom/instabug/library/annotation/b$a;
    ...
    iput-object v0, p1, Lcom/instabug/library/annotation/b;->x:Lcom/instabug/library/annotation/b$b;
