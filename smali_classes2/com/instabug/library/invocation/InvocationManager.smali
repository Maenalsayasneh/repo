...
# instance fields
.field private currentActivityLifeCycleDisposable:Lk0/b/w/a;
...
.field private invocationRequestListenerImp:Li0/j/e/m0/c;

.field private isInvocationAvailable:Z

.field private lastUsedInvoker:Li0/j/e/m0/d/a;
...
.method private constructor <init>()V
    ...
    .line 7
    new-instance v0, Li0/j/e/m0/c;

    invoke-direct {v0}, Li0/j/e/m0/c;-><init>()V

    iput-object v0, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;

    return-void
.end method

.method private getFloatingButtonInvoker()Li0/j/e/m0/d/b;
    .locals 3
    ...
    check-cast v1, Li0/j/e/m0/d/a;

    .line 3
    instance-of v2, v1, Li0/j/e/m0/d/b;

    if-eqz v2, :cond_0

    .line 4
    check-cast v1, Li0/j/e/m0/d/b;
...
.method private subscribeToCarenActivityLifeCycle()V
    ...
    iput-object v0, p0, Lcom/instabug/library/invocation/InvocationManager;->currentActivityLifeCycleDisposable:Lk0/b/w/a;
...
.method public forceInvoke(I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;
    ...
    .line 2
    :cond_0
    invoke-virtual {v0, v2}, Li0/j/e/m0/c;->d(I)V

    goto :goto_2

    .line 3
    :cond_1
    invoke-virtual {v0, v3}, Li0/j/e/m0/c;->d(I)V
    ...
    .line 4
    :cond_2
    invoke-static {v4, v2}, Li0/j/c/l/a;->m(IZ)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 5
    :cond_3
    invoke-static {v2, v2}, Li0/j/c/l/a;->m(IZ)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 6
    invoke-static {p1, v2}, Li0/j/c/l/a;->m(IZ)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 8
    invoke-virtual {v0, p1}, Li0/j/e/m0/c;->b(Lcom/instabug/library/core/plugin/PluginPromptOption;)V

    goto :goto_2

    .line 9
    :cond_5
    invoke-virtual {v0, v1, p1}, Li0/j/e/m0/c;->a(Landroid/net/Uri;Lcom/instabug/library/core/plugin/PluginPromptOption;)V
...
.method public getAvailablePromptOptions()Ljava/util/ArrayList;
    ...
    .line 1
    invoke-static {}, Li0/j/e/y/b/a;->d()Ljava/util/ArrayList;
...
.method public getLastUsedInvoker()Li0/j/e/m0/d/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/instabug/library/invocation/InvocationManager;->lastUsedInvoker:Li0/j/e/m0/d/a;
...
.method public handle(Landroid/view/MotionEvent;)V
    ...
    .line 4
    instance-of v2, v1, Li0/j/e/m0/d/l;

    if-eqz v2, :cond_0

    .line 5
    check-cast v1, Li0/j/e/m0/d/l;
    ...
    .line 7
    :try_start_0
    iget-object v0, v1, Li0/j/e/m0/d/l;->c:Lh0/i/i/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 10
    :try_start_2
    iput-boolean v0, v1, Li0/j/e/m0/d/l;->x:Z
...
.method public invoke(I)V
    ...
    .line 2
    :cond_0
    invoke-virtual {v0, v1}, Li0/j/e/m0/c;->d(I)V

    goto :goto_2

    .line 3
    :cond_1
    invoke-virtual {v0, v4}, Li0/j/e/m0/c;->d(I)V
    ...
    .line 4
    :cond_2
    invoke-static {v1, v3}, Li0/j/c/l/a;->m(IZ)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 6
    :cond_4
    invoke-static {v3, v3}, Li0/j/c/l/a;->m(IZ)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 9
    :cond_5
    invoke-virtual {v0, v2, p1}, Li0/j/e/m0/c;->a(Landroid/net/Uri;Lcom/instabug/library/core/plugin/PluginPromptOption;)V
...
.method public listen()V
    ...
    .line 6
    invoke-interface {v1}, Li0/j/e/m0/d/a;->b()Z

    move-result v2

    if-nez v2, :cond_0

    invoke-interface {v1}, Li0/j/e/m0/d/a;->a()V
...
.method public notifyInvocationOptionChanged()V
    ...
    .line 2
    invoke-direct {p0}, Lcom/instabug/library/invocation/InvocationManager;->getFloatingButtonInvoker()Li0/j/e/m0/d/b;
    ...
    .line 3
    invoke-virtual {v1}, Li0/j/e/m0/d/b;->c()V

    goto :goto_0

    .line 4
    :cond_0
    new-instance v0, Li0/j/e/m0/d/c;

    invoke-direct {v0, v1}, Li0/j/e/m0/d/c;-><init>(Li0/j/e/m0/d/b;)V
...
.method public notifyPrimaryColorChanged()V
    ...
    invoke-direct {v2, v1}, Lcom/instabug/library/invocation/InvocationManager$b;-><init>(Li0/j/e/m0/d/a;)V
...
.method public release()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/library/invocation/InvocationManager;->currentActivityLifeCycleDisposable:Lk0/b/w/a;
...
.method public varargs setInstabugInvocationEvent([Lcom/instabug/library/invocation/InstabugInvocationEvent;)V
    ...
    .line 4
    invoke-interface {v1}, Li0/j/e/m0/d/a;->c()V
    ...
    .line 13
    iget-object v5, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;
    ...
    new-instance v4, Li0/j/e/m0/d/i;

    iget-object v5, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;

    invoke-direct {v4, v5}, Li0/j/e/m0/d/i;-><init>(Li0/j/e/m0/a;)V
    ...
    .line 16
    new-instance v4, Li0/j/e/m0/d/l;

    iget-object v5, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;

    invoke-direct {v4, v3, v5}, Li0/j/e/m0/d/l;-><init>(Landroid/content/Context;Li0/j/e/m0/a;)V
    ...
    new-instance v4, Li0/j/e/m0/d/b;

    iget-object v5, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;

    invoke-direct {v4, v5}, Li0/j/e/m0/d/b;-><init>(Li0/j/e/m0/a;)V
    ...
    .line 20
    new-instance v4, Li0/j/e/m0/d/k;

    iget-object v5, p0, Lcom/instabug/library/invocation/InvocationManager;->invocationRequestListenerImp:Li0/j/e/m0/c;

    invoke-direct {v4, v3, v5}, Li0/j/e/m0/d/k;-><init>(Landroid/content/Context;Li0/j/e/m0/a;)V
    ...
    .line 23
    iget-object v5, v4, Li0/j/e/m0/d/k;->c:Li0/j/e/d1/f;

    .line 24
    iput v3, v5, Li0/j/e/d1/f;->a2:I
    ...
    .line 28
    invoke-virtual {p0, v3}, Lcom/instabug/library/invocation/InvocationManager;->setLastUsedInvoker(Li0/j/e/m0/d/a;)V
...
.method public setLastUsedInvoker(Li0/j/e/m0/d/a;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/instabug/library/invocation/InvocationManager;->lastUsedInvoker:Li0/j/e/m0/d/a;
...
.method public show()V
    ...
    .line 2
    invoke-virtual {v0, v1}, Li0/j/e/m0/c;->c(Landroid/net/Uri;)V

    .line 3
    :cond_0
    iput-object v1, p0, Lcom/instabug/library/invocation/InvocationManager;->lastUsedInvoker:Li0/j/e/m0/d/a;
