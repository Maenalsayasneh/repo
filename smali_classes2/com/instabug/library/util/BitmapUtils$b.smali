...
.field public final synthetic y:Lcom/instabug/library/util/BitmapUtils$OnSaveBitmapCallback;
...
.method public constructor <init>(Ljava/io/File;Ljava/lang/String;Landroid/graphics/Bitmap;ILcom/instabug/library/util/BitmapUtils$OnSaveBitmapCallback;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/instabug/library/util/BitmapUtils$b;->c:Ljava/io/File;

    iput-object p2, p0, Lcom/instabug/library/util/BitmapUtils$b;->d:Ljava/lang/String;

    iput-object p3, p0, Lcom/instabug/library/util/BitmapUtils$b;->q:Landroid/graphics/Bitmap;

    iput p4, p0, Lcom/instabug/library/util/BitmapUtils$b;->x:I

    iput-object p5, p0, Lcom/instabug/library/util/BitmapUtils$b;->y:Lcom/instabug/library/util/BitmapUtils$OnSaveBitmapCallback;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/instabug/library/util/BitmapUtils$b;->c:Ljava/io/File;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v3, p0, Lcom/instabug/library/util/BitmapUtils$b;->d:Ljava/lang/String;
    ...
    .line 5
    iget-object v2, p0, Lcom/instabug/library/util/BitmapUtils$b;->q:Landroid/graphics/Bitmap;

    sget-object v3, Landroid/graphics/Bitmap$CompressFormat;->PNG:Landroid/graphics/Bitmap$CompressFormat;

    iget v4, p0, Lcom/instabug/library/util/BitmapUtils$b;->x:I
    ...
    .line 8
    iget-object v1, p0, Lcom/instabug/library/util/BitmapUtils$b;->y:Lcom/instabug/library/util/BitmapUtils$OnSaveBitmapCallback;
    ...
    .line 9
    :cond_0
    iget-object v0, p0, Lcom/instabug/library/util/BitmapUtils$b;->y:Lcom/instabug/library/util/BitmapUtils$OnSaveBitmapCallback;
