...
# instance fields
.field private coreEventsDisposable:Lk0/b/w/a;
...
.method private subscribeOnCoreEvents()V
    ...
    .line 4
    new-instance v1, Li0/j/b/g;

    invoke-direct {v1, v0}, Li0/j/b/g;-><init>(Landroid/content/Context;)V
    ...
    .line 6
    iput-object v0, p0, Lcom/instabug/bug/BugPlugin;->coreEventsDisposable:Lk0/b/w/a;
...
.method private unSubscribeFromCoreEvents()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/bug/BugPlugin;->coreEventsDisposable:Lk0/b/w/a;
...
.method public getPluginOptions(Z)Ljava/util/ArrayList;
    ...
    .line 5
    new-instance p1, Li0/j/b/l/c;

    invoke-direct {p1}, Li0/j/b/l/c;-><init>()V

    invoke-virtual {p1, v0}, Li0/j/b/l/c;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 6
    new-instance p1, Li0/j/b/l/d;

    invoke-direct {p1}, Li0/j/b/l/d;-><init>()V

    invoke-virtual {p1, v0}, Li0/j/b/l/d;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 7
    new-instance p1, Li0/j/b/l/a;

    invoke-direct {p1}, Li0/j/b/l/a;-><init>()V

    invoke-virtual {p1, v0}, Li0/j/b/l/a;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
...
.method public getPromptOptions()Ljava/util/ArrayList;
    ...
    .line 5
    invoke-static {v2}, Li0/j/b/i;->c(Ljava/lang/String;)Z
    ...
    .line 6
    new-instance v2, Li0/j/b/l/c;

    invoke-direct {v2}, Li0/j/b/l/c;-><init>()V

    invoke-virtual {v2, v0}, Li0/j/b/l/c;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 8
    new-instance v2, Li0/j/b/l/d;

    invoke-direct {v2}, Li0/j/b/l/d;-><init>()V

    invoke-virtual {v2, v0}, Li0/j/b/l/d;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 11
    new-instance v2, Li0/j/b/l/a;

    invoke-direct {v2}, Li0/j/b/l/a;-><init>()V

    invoke-virtual {v2, v0}, Li0/j/b/l/a;->g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
...
.method public initDefaultPromptOptionAvailabilityState()V
    ...
    invoke-static {v0}, Li0/h/a/b/c/m/b;->r([I)V
