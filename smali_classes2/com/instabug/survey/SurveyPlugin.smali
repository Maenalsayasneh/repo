...
# instance fields
.field private announcementManager:Li0/j/f/l/g;

.field private subscribe:Lk0/b/w/a;

.field private userTypeDisposable:Lk0/b/w/a;
...
.method private checkAppStatus()V
    ...
    .line 4
    iget-object v1, v1, Li0/j/f/o/a;->i:Ljava/lang/Boolean;
    ...
    .line 9
    invoke-virtual {v1, v2}, Lcom/instabug/library/network/NetworkManager;->doRequest(Lcom/instabug/library/network/Request;)Lk0/b/l;
    ...
    new-instance v1, Li0/j/f/p/a;

    invoke-direct {v1}, Li0/j/f/p/a;-><init>()V
...
.method private static clearUserActivities()V
    ...
    invoke-virtual {v0, v1, v2}, Li0/j/f/o/b;->a(J)V
    ...
    .line 4
    iget-object v3, v0, Li0/j/f/o/b;->c:Landroid/content/SharedPreferences$Editor;
    ...
    .line 5
    iget-object v0, v0, Li0/j/f/o/b;->c:Landroid/content/SharedPreferences$Editor;
...
.method private initAnnouncementSettings(Landroid/content/Context;)V
    ...
    .line 1
    invoke-static {p1}, Li0/j/f/l/g;->a(Landroid/content/Context;)Li0/j/f/l/g;

    move-result-object v0

    iput-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->announcementManager:Li0/j/f/l/g;

    .line 2
    new-instance v0, Li0/j/f/l/i/b;

    invoke-direct {v0, p1}, Li0/j/f/l/i/b;-><init>(Landroid/content/Context;)V

    sput-object v0, Li0/j/f/l/i/b;->a:Li0/j/f/l/i/b;
...
.method private startFetchingRequests()V
    ...
    .line 3
    new-instance v0, Li0/j/f/q/a;

    invoke-direct {v0}, Li0/j/f/q/a;-><init>()V

    invoke-virtual {p0, v0}, Lcom/instabug/survey/SurveyPlugin;->resolveCountryInfo(Li0/j/f/q/a;)V
...
.method private unSubscribeOnSDKEvents()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->subscribe:Lk0/b/w/a;
...
.method public getLastActivityTime()J
    ...
    .line 3
    iget-object v0, v0, Li0/j/f/o/b;->b:Landroid/content/SharedPreferences;
...
.method public resolveCountryInfo(Li0/j/f/q/a;)V
    .locals 9
    ...
    .line 8
    :try_start_0
    invoke-static {}, Li0/j/f/o/c;->a()Ljava/lang/String;

    move-result-object v1

    .line 9
    sget-wide v2, Li0/j/f/o/c;->a:J

    if-eqz v1, :cond_0

    .line 10
    invoke-virtual {p1, v1}, Li0/j/f/q/a;->fromJson(Ljava/lang/String;)V

    .line 11
    iget-wide v2, p1, Li0/j/f/q/a;->x:J
    ...
    .line 15
    iget-object v1, v1, Li0/j/f/o/b;->b:Landroid/content/SharedPreferences;
    ...
    .line 17
    iget-object p1, v0, Li0/j/f/h;->b:Ljava/lang/ref/WeakReference;
    ...
    .line 18
    iget-object p1, v0, Li0/j/f/h;->f:Li0/j/f/n/a;

    iget-object v1, v0, Li0/j/f/h;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p1, v1}, Li0/j/f/n/a;->a(Landroid/content/Context;)V

    goto :goto_1

    .line 19
    :cond_2
    invoke-virtual {v0, p1}, Li0/j/f/h;->b(Li0/j/f/q/a;)V
    :try_end_0
...
.method public shouldReFetch()Z
    ...
    .line 4
    iget-object v1, v1, Li0/j/f/o/a;->h:Ljava/lang/String;
...
.method public sleep()V
    ...
    .line 1
    iget-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->announcementManager:Li0/j/f/l/g;

    .line 2
    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    .line 3
    invoke-static {}, Li0/j/f/l/i/b;->a()Li0/j/f/l/i/b;
    ...
    iget-object v0, v0, Li0/j/f/l/g;->b:Landroid/content/Context;
    ...
    .line 6
    iget-object v2, v1, Li0/j/f/l/i/b;->c:Landroid/content/SharedPreferences$Editor;
    ...
    .line 7
    iget-object v0, v1, Li0/j/f/l/i/b;->c:Landroid/content/SharedPreferences$Editor;
    ...
    .line 11
    :try_start_0
    invoke-virtual {v0}, Li0/j/f/h;->g()V
    ...
    .line 17
    iput-object v2, v1, Li0/j/f/m/c;->c:Ljava/lang/Runnable;

    iput-object v2, v1, Li0/j/f/m/c;->b:Ljava/lang/Runnable;

    .line 18
    sget-object v1, Li0/j/f/h;->a:Li0/j/f/h;

    if-eqz v1, :cond_1

    .line 19
    sput-object v2, Li0/j/f/h;->a:Li0/j/f/h;
    :try_end_0
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->userTypeDisposable:Lk0/b/w/a;
...
.method public startFetchingAnnouncements(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Li0/j/f/l/g;->a(Landroid/content/Context;)Li0/j/f/l/g;

    move-result-object v1

    .line 5
    iget-object v3, v1, Li0/j/f/l/g;->b:Landroid/content/Context;
    ...
    invoke-static {}, Li0/j/f/l/i/a;->a()Li0/j/f/l/i/a;
    ...
    .line 12
    iget-object v0, v0, Li0/j/f/l/i/b;->b:Landroid/content/SharedPreferences;
    ...
    .line 13
    sget-object v0, Li0/j/f/b/b/b;->a:Li0/j/f/b/b/b;

    if-nez v0, :cond_2

    .line 14
    new-instance v0, Li0/j/f/b/b/b;

    invoke-direct {v0}, Li0/j/f/b/b/b;-><init>()V

    sput-object v0, Li0/j/f/b/b/b;->a:Li0/j/f/b/b/b;
    ...
    .line 16
    iget-object v2, v1, Li0/j/f/l/g;->b:Landroid/content/Context;

    new-instance v3, Li0/j/f/l/b;

    invoke-direct {v3, v1}, Li0/j/f/l/b;-><init>(Li0/j/f/l/g;)V

    invoke-virtual {v0, v2, p1, v3}, Li0/j/f/b/b/b;->a(Landroid/content/Context;Ljava/lang/String;Lcom/instabug/library/network/Request$Callbacks;)V

    goto :goto_2

    .line 17
    :cond_3
    invoke-virtual {v1}, Li0/j/f/l/g;->e()Li0/j/f/l/h;

    move-result-object p1

    invoke-virtual {p1}, Li0/j/f/l/h;->a()Lcom/instabug/survey/e/c/a;
    ...
    .line 18
    new-instance v0, Li0/j/f/l/c;

    invoke-direct {v0, v1, p1}, Li0/j/f/l/c;-><init>(Li0/j/f/l/g;Lcom/instabug/survey/e/c/a;)V
    ...
    .line 19
    invoke-virtual {v1, p1}, Li0/j/f/l/g;->d(Ljava/lang/Throwable;)V
...
.method public startFetchingSurveys(Ljava/lang/String;)V
    ...
    .line 8
    iget-object v1, v0, Li0/j/f/h;->g:Lcom/instabug/library/util/TaskDebouncer;

    new-instance v2, Li0/j/f/g;

    invoke-direct {v2, v0, p1}, Li0/j/f/g;-><init>(Li0/j/f/h;Ljava/lang/String;)V
...
.method public stop()V
    ...
    .line 1
    sput-object v0, Li0/j/f/o/b;->a:Li0/j/f/o/b;

    .line 2
    const-class v1, Li0/j/f/o/a;

    monitor-enter v1

    .line 3
    :try_start_0
    sput-object v0, Li0/j/f/o/a;->a:Li0/j/f/o/a;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public subscribeOnSDKEvents()V
    ...
    iput-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->subscribe:Lk0/b/w/a;
...
.method public wake()V
    ...
    .line 6
    new-instance v0, Li0/j/f/i;

    invoke-direct {v0}, Li0/j/f/i;-><init>()V
    ...
    iput-object v0, p0, Lcom/instabug/survey/SurveyPlugin;->userTypeDisposable:Lk0/b/w/a;
