...
.method public constructor <init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
    ...
    .line 4
    iput-object p4, p0, Lcom/pubnub/api/endpoints/Endpoint;->tokenManager:Lcom/pubnub/api/managers/token_manager/TokenManager;
...
.method public static synthetic access$100(Lcom/pubnub/api/endpoints/Endpoint;Lt0/v;Ljava/lang/String;Lcom/google/gson/JsonElement;)Lcom/pubnub/api/PubNubException;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/pubnub/api/endpoints/Endpoint;->createPubNubException(Lt0/v;Ljava/lang/String;Lcom/google/gson/JsonElement;)Lcom/pubnub/api/PubNubException;
...
.method public static synthetic access$200(Lcom/pubnub/api/endpoints/Endpoint;Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;Ljava/util/ArrayList;Ljava/util/ArrayList;)Lcom/pubnub/api/models/consumer/PNStatus;
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, Lcom/pubnub/api/endpoints/Endpoint;->createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;Ljava/util/ArrayList;Ljava/util/ArrayList;)Lcom/pubnub/api/models/consumer/PNStatus;
...
.method public static synthetic access$300(Lcom/pubnub/api/endpoints/Endpoint;Lt0/v;Lcom/pubnub/api/enums/PNOperationType;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/pubnub/api/endpoints/Endpoint;->storeRequestLatency(Lt0/v;Lcom/pubnub/api/enums/PNOperationType;)V
...
.method private createPubNubException(Lt0/v;Ljava/lang/String;Lcom/google/gson/JsonElement;)Lcom/pubnub/api/PubNubException;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v0, p1, Lt0/v;->a:Lq0/e0;

    .line 2
    iget v0, v0, Lq0/e0;->y:I
    ...
    iget-object p2, p0, Lcom/pubnub/api/endpoints/Endpoint;->call:Lt0/d;

    .line 10
    invoke-virtual {p1, p2}, Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;->affectedCall(Lt0/d;)Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;
    ...
    iget-object v1, p0, Lcom/pubnub/api/endpoints/Endpoint;->call:Lt0/d;

    .line 14
    invoke-virtual {p2, v1}, Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;->affectedCall(Lt0/d;)Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;
...
.method private createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;Ljava/util/ArrayList;Ljava/util/ArrayList;)Lcom/pubnub/api/models/consumer/PNStatus;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 22
    invoke-virtual {p3, v1}, Lq0/w;->h(Ljava/lang/String;)Ljava/lang/String;
...
.method private storeRequestLatency(Lt0/v;Lcom/pubnub/api/enums/PNOperationType;)V
    .locals 5
    ...
    .line 3
    iget-wide v1, p1, Lq0/e0;->f2:J

    .line 4
    iget-wide v3, p1, Lq0/e0;->e2:J
...
.method public async(Lcom/pubnub/api/callbacks/PNCallback;)V
    ...
    invoke-virtual {p0, v0}, Lcom/pubnub/api/endpoints/Endpoint;->doWork(Ljava/util/Map;)Lt0/d;

    move-result-object v0

    iput-object v0, p0, Lcom/pubnub/api/endpoints/Endpoint;->call:Lt0/d;
    :try_end_0
    ...
    .line 6
    invoke-direct/range {v1 .. v6}, Lcom/pubnub/api/endpoints/Endpoint;->createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;Ljava/util/ArrayList;Ljava/util/ArrayList;)Lcom/pubnub/api/models/consumer/PNStatus;
...
.method public createBaseParams()Ljava/util/Map;
    ...
    .line 11
    iget-object v1, p0, Lcom/pubnub/api/endpoints/Endpoint;->tokenManager:Lcom/pubnub/api/managers/token_manager/TokenManager;

    invoke-virtual {v1}, Lcom/pubnub/api/managers/token_manager/TokenManager;->getToken()Ljava/lang/String;
...
.method public abstract createResponse(Lt0/v;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lt0/v<",
...
.method public abstract doWork(Ljava/util/Map;)Lt0/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Map<",
...
.method public silentCancel()V
    ...
    .line 1
    iget-object v0, p0, Lcom/pubnub/api/endpoints/Endpoint;->call:Lt0/d;
...
.method public sync()Ljava/lang/Object;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lcom/pubnub/api/endpoints/Endpoint;->isError(Lt0/v;)Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/pubnub/api/endpoints/Endpoint;->storeRequestLatency(Lt0/v;Lcom/pubnub/api/enums/PNOperationType;)V

    .line 6
    invoke-virtual {p0, v0}, Lcom/pubnub/api/endpoints/Endpoint;->createResponse(Lt0/v;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_1
    iget-object v1, v0, Lt0/v;->c:Lq0/f0;

    .line 8
    invoke-virtual {v1}, Lq0/f0;->string()Ljava/lang/String;
    ...
    .line 10
    :goto_1
    invoke-direct {p0, v0, v1, v2}, Lcom/pubnub/api/endpoints/Endpoint;->createPubNubException(Lt0/v;Ljava/lang/String;Lcom/google/gson/JsonElement;)Lcom/pubnub/api/PubNubException;
    ...
    iget-object v2, p0, Lcom/pubnub/api/endpoints/Endpoint;->call:Lt0/d;
