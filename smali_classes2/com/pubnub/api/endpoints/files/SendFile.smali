...
.method public static builder(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)Lcom/pubnub/api/endpoints/files/SendFile$Builder;
    .locals 1

    .line 1
    new-instance v0, Lcom/pubnub/api/endpoints/files/SendFile$Builder;

    invoke-direct {v0, p0, p1, p2, p3}, Lcom/pubnub/api/endpoints/files/SendFile$Builder;-><init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
...
.method private mapPublishFileMessageToFileUpload(Ljava/util/concurrent/atomic/AtomicReference;Lcom/pubnub/api/models/consumer/files/PNPublishFileMessageResult;)Lcom/pubnub/api/endpoints/remoteaction/RemoteAction;
    ...
    .line 1
    new-instance v0, Li0/m/a/a/a/h;

    invoke-direct {v0, p1}, Li0/m/a/a/a/h;-><init>(Ljava/util/concurrent/atomic/AtomicReference;)V
...
.method private sendFileComposedActions(Lcom/pubnub/api/endpoints/files/GenerateUploadUrl$Factory;Lcom/pubnub/api/endpoints/BuilderSteps$ChannelStep;Lcom/pubnub/api/endpoints/files/UploadFile$Factory;)Lcom/pubnub/api/endpoints/remoteaction/RemoteAction;
    ...
    new-instance v1, Li0/m/a/a/a/f;

    invoke-direct {v1, p0, v0, p3}, Li0/m/a/a/a/f;-><init>(Lcom/pubnub/api/endpoints/files/SendFile;Ljava/util/concurrent/atomic/AtomicReference;Lcom/pubnub/api/endpoints/files/UploadFile$Factory;)V
    ...
    new-instance p3, Li0/m/a/a/a/g;

    invoke-direct {p3, p0, p2, v0}, Li0/m/a/a/a/g;-><init>(Lcom/pubnub/api/endpoints/files/SendFile;Lcom/pubnub/api/endpoints/BuilderSteps$ChannelStep;Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    new-instance p2, Li0/m/a/a/a/j;

    invoke-direct {p2, p0, v0}, Li0/m/a/a/a/j;-><init>(Lcom/pubnub/api/endpoints/files/SendFile;Ljava/util/concurrent/atomic/AtomicReference;)V
...
.method public async(Lcom/pubnub/api/callbacks/PNCallback;)V
    ...
    new-instance v1, Li0/m/a/a/a/i;

    invoke-direct {v1, p0, p1}, Li0/m/a/a/a/i;-><init>(Lcom/pubnub/api/endpoints/files/SendFile;Lcom/pubnub/api/callbacks/PNCallback;)V
