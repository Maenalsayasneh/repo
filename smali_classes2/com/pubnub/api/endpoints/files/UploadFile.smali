...
# static fields
.field private static final APPLICATION_OCTET_STREAM:Lq0/y;

.field private static final CONTENT_TYPE_HEADER:Ljava/lang/String; = "Content-Type"

.field private static final FILE_PART_MULTIPART:Ljava/lang/String; = "file"

.field private static final log:Ls0/c/b;


# instance fields
.field private final baseUrl:Ljava/lang/String;

.field private call:Lt0/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lt0/d<",
            "Ljava/lang/Void;",
...
.method public static constructor <clinit>()V
    ...
    invoke-static {v0}, Ls0/c/c;->e(Ljava/lang/Class;)Ls0/c/b;

    move-result-object v0

    sput-object v0, Lcom/pubnub/api/endpoints/files/UploadFile;->log:Ls0/c/b;
    ...
    sput-object v0, Lcom/pubnub/api/endpoints/files/UploadFile;->APPLICATION_OCTET_STREAM:Lq0/y;
...
.method public static synthetic access$000(Lcom/pubnub/api/endpoints/files/UploadFile;Lt0/v;)Lcom/pubnub/api/PubNubException;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/pubnub/api/endpoints/files/UploadFile;->createException(Lt0/v;)Lcom/pubnub/api/PubNubException;
...
.method public static synthetic access$100(Lcom/pubnub/api/endpoints/files/UploadFile;Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;)Lcom/pubnub/api/models/consumer/PNStatus;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/pubnub/api/endpoints/files/UploadFile;->createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;)Lcom/pubnub/api/models/consumer/PNStatus;
...
.method public static synthetic access$200(Lcom/pubnub/api/endpoints/files/UploadFile;)Lt0/d;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/pubnub/api/endpoints/files/UploadFile;->call:Lt0/d;

    return-object p0
.end method

.method private static addFormParamsWithKeyFirst(Lcom/pubnub/api/models/server/files/FormField;Ljava/util/List;Lq0/z$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, v0, v1}, Lq0/z$a;->a(Ljava/lang/String;Ljava/lang/String;)Lq0/z$a;
    ...
    invoke-virtual {p2, v1, v0}, Lq0/z$a;->a(Ljava/lang/String;Ljava/lang/String;)Lq0/z$a;
...
.method private createException(Lt0/v;)Lcom/pubnub/api/PubNubException;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iget-object v2, p1, Lt0/v;->c:Lq0/f0;

    .line 4
    invoke-virtual {v2}, Lq0/f0;->byteStream()Ljava/io/InputStream;
    ...
    iget-object v1, p0, Lcom/pubnub/api/endpoints/files/UploadFile;->call:Lt0/d;

    .line 12
    invoke-virtual {v0, v1}, Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;->affectedCall(Lt0/d;)Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;
    ...
    iget-object v2, p0, Lcom/pubnub/api/endpoints/files/UploadFile;->call:Lt0/d;

    .line 20
    invoke-virtual {v1, v2}, Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;->affectedCall(Lt0/d;)Lcom/pubnub/api/PubNubException$PubNubExceptionBuilder;
...
.method private createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;)Lcom/pubnub/api/models/consumer/PNStatus;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iget-object p3, p2, Lt0/v;->a:Lq0/e0;

    .line 6
    iget p3, p3, Lq0/e0;->y:I
    ...
    .line 9
    iget-object p3, p3, Lq0/e0;->d:Lq0/b0;

    .line 10
    iget-object p3, p3, Lq0/b0;->b:Lq0/w;

    .line 11
    iget-boolean p3, p3, Lq0/w;->c:Z
    ...
    .line 19
    iget-object p2, p2, Lq0/e0;->d:Lq0/b0;
...
.method private getMediaType(Ljava/lang/String;)Lq0/y;
    .locals 4

    if-nez p1, :cond_0

    .line 1
    sget-object p1, Lcom/pubnub/api/endpoints/files/UploadFile;->APPLICATION_OCTET_STREAM:Lq0/y;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Lq0/y;->b(Ljava/lang/String;)Lq0/y;
    ...
    .line 3
    sget-object v1, Lcom/pubnub/api/endpoints/files/UploadFile;->log:Ls0/c/b;
    ...
    invoke-interface {v1, p1, v0}, Ls0/c/b;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private prepareCall()Lt0/d;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    invoke-direct {v0, v1, v2}, Lq0/z$a;-><init>(Ljava/lang/String;I)V

    .line 3
    sget-object v1, Lq0/z;->c:Lq0/y;

    invoke-virtual {v0, v1}, Lq0/z$a;->d(Lq0/y;)Lq0/z$a;
    ...
    invoke-static {v1, v2, v0}, Lcom/pubnub/api/endpoints/files/UploadFile;->addFormParamsWithKeyFirst(Lcom/pubnub/api/models/server/files/FormField;Ljava/util/List;Lq0/z$a;)V
    ...
    invoke-direct {p0, v1}, Lcom/pubnub/api/endpoints/files/UploadFile;->getMediaType(Ljava/lang/String;)Lq0/y;
    ...
    invoke-static {v1, v2}, Lq0/d0;->c(Lq0/y;[B)Lq0/d0;
    ...
    .line 11
    invoke-static {v2, v3, v1}, Lq0/z$c;->b(Ljava/lang/String;Ljava/lang/String;Lq0/d0;)Lq0/z$c;

    move-result-object v1

    invoke-virtual {v0, v1}, Lq0/z$a;->b(Lq0/z$c;)Lq0/z$a;
    ...
    invoke-virtual {v0}, Lq0/z$a;->c()Lq0/z;

    move-result-object v0

    invoke-interface {v1, v2, v0}, Lcom/pubnub/api/services/S3Service;->upload(Ljava/lang/String;Lq0/z;)Lt0/d;
...
.method public async(Lcom/pubnub/api/callbacks/PNCallback;)V
    ...
    .line 1
    :try_start_0
    invoke-direct {p0}, Lcom/pubnub/api/endpoints/files/UploadFile;->prepareCall()Lt0/d;

    move-result-object v0

    iput-object v0, p0, Lcom/pubnub/api/endpoints/files/UploadFile;->call:Lt0/d;
    ...
    invoke-interface {v0, v1}, Lt0/d;->J(Lt0/f;)V
    :try_end_0
    ...
    .line 4
    invoke-direct {p0, v1, v2, v0}, Lcom/pubnub/api/endpoints/files/UploadFile;->createStatusResponse(Lcom/pubnub/api/enums/PNStatusCategory;Lt0/v;Ljava/lang/Exception;)Lcom/pubnub/api/models/consumer/PNStatus;
...
.method public silentCancel()V
    ...
    .line 1
    iget-object v0, p0, Lcom/pubnub/api/endpoints/files/UploadFile;->call:Lt0/d;

    invoke-interface {v0}, Lt0/d;->isCanceled()Z
...
.method public sync()Ljava/lang/Void;
    ...
    .line 3
    :try_start_1
    invoke-interface {v0}, Lt0/d;->execute()Lt0/v;
    ...
    .line 5
    :cond_0
    invoke-direct {p0, v0}, Lcom/pubnub/api/endpoints/files/UploadFile;->createException(Lt0/v;)Lcom/pubnub/api/PubNubException;
