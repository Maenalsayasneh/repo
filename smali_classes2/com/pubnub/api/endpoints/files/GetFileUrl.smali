...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
    .locals 0

    .line 1
    invoke-direct {p0, p4, p5, p6, p7}, Lcom/pubnub/api/endpoints/Endpoint;-><init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
...
.method public static builder(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)Lcom/pubnub/api/endpoints/files/GetFileUrl$Builder;
    .locals 2

    .line 1
    new-instance v0, Lcom/pubnub/api/endpoints/files/GetFileUrl$Builder;

    new-instance v1, Li0/m/a/a/a/d;

    invoke-direct {v1, p0, p1, p2, p3}, Li0/m/a/a/a/d;-><init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
...
.method public async(Lcom/pubnub/api/callbacks/PNCallback;)V
    ...
    new-instance v1, Li0/m/a/a/a/c;

    invoke-direct {v1, p0, p1}, Li0/m/a/a/a/c;-><init>(Lcom/pubnub/api/endpoints/files/GetFileUrl;Lcom/pubnub/api/callbacks/PNCallback;)V
...
.method public createResponse(Lt0/v;)Lcom/pubnub/api/models/consumer/files/PNFileUrlResult;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic createResponse(Lt0/v;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/files/GetFileUrl;->createResponse(Lt0/v;)Lcom/pubnub/api/models/consumer/files/PNFileUrlResult;
...
.method public sync()Lcom/pubnub/api/models/consumer/files/PNFileUrlResult;
    ...
    invoke-interface/range {v0 .. v5}, Lcom/pubnub/api/services/FilesService;->downloadFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lt0/d;

    move-result-object v0

    .line 5
    invoke-interface {v0}, Lt0/d;->request()Lq0/b0;
