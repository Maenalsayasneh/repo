...
# direct methods
.method public constructor <init>(Ljava/util/Collection;Ljava/util/Collection;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships;-><init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;Lcom/pubnub/api/managers/token_manager/TokenManager;)V
...
# virtual methods
.method public createResponse(Lt0/v;)Lcom/pubnub/api/models/consumer/objects_api/membership/PNManageMembershipResult;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic createResponse(Lt0/v;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMembershipsCommand;->createResponse(Lt0/v;)Lcom/pubnub/api/models/consumer/objects_api/membership/PNManageMembershipResult;
...
.method public executeCommand(Ljava/util/Map;)Lt0/d;
    ...
    invoke-interface {v1, v2, v3, v0, p1}, Lcom/pubnub/api/services/UUIDMetadataService;->patchMembership(Ljava/lang/String;Ljava/lang/String;Lcom/pubnub/api/models/server/objects_api/PatchMembershipPayload;Ljava/util/Map;)Lt0/d;
