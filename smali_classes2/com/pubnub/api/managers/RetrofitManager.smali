...
.field private noSignatureClientInstance:Lq0/a0;

.field private final noSignatureInstance:Lt0/w;
...
.field private subscriptionClientInstance:Lq0/a0;

.field private final subscriptionInstance:Lt0/w;

.field private timeService:Lcom/pubnub/api/services/TimeService;

.field private transactionClientInstance:Lq0/a0;

.field private final transactionInstance:Lt0/w;
...
.method public constructor <init>(Lcom/pubnub/api/PubNub;)V
    ...
    .line 8
    invoke-direct {p0, p1, v0}, Lcom/pubnub/api/managers/RetrofitManager;->prepareOkHttpClient(II)Lq0/a0$a;
    ...
    .line 9
    invoke-virtual {p1, v0}, Lq0/a0$a;->a(Lq0/x;)Lq0/a0$a;

    const/4 v0, 0x0

    .line 10
    iput-boolean v0, p1, Lq0/a0$a;->f:Z

    .line 11
    invoke-direct {p0, p1}, Lcom/pubnub/api/managers/RetrofitManager;->createOkHttpClient(Lq0/a0$a;)Lq0/a0;

    move-result-object p1

    iput-object p1, p0, Lcom/pubnub/api/managers/RetrofitManager;->transactionClientInstance:Lq0/a0;
    ...
    .line 15
    invoke-direct {p0, p1, v1}, Lcom/pubnub/api/managers/RetrofitManager;->prepareOkHttpClient(II)Lq0/a0$a;
    ...
    .line 16
    invoke-virtual {p1, v1}, Lq0/a0$a;->a(Lq0/x;)Lq0/a0$a;
    ...
    iput-object p1, p0, Lcom/pubnub/api/managers/RetrofitManager;->subscriptionClientInstance:Lq0/a0;
    ...
    iput-object p1, p0, Lcom/pubnub/api/managers/RetrofitManager;->noSignatureClientInstance:Lq0/a0;

    .line 25
    :cond_0
    iget-object p1, p0, Lcom/pubnub/api/managers/RetrofitManager;->transactionClientInstance:Lq0/a0;

    invoke-direct {p0, p1}, Lcom/pubnub/api/managers/RetrofitManager;->createRetrofit(Lq0/a0;)Lt0/w;

    move-result-object p1

    iput-object p1, p0, Lcom/pubnub/api/managers/RetrofitManager;->transactionInstance:Lt0/w;

    .line 26
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->subscriptionClientInstance:Lq0/a0;

    invoke-direct {p0, v0}, Lcom/pubnub/api/managers/RetrofitManager;->createRetrofit(Lq0/a0;)Lt0/w;

    move-result-object v0

    iput-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->subscriptionInstance:Lt0/w;

    .line 27
    iget-object v1, p0, Lcom/pubnub/api/managers/RetrofitManager;->noSignatureClientInstance:Lq0/a0;

    invoke-direct {p0, v1}, Lcom/pubnub/api/managers/RetrofitManager;->createRetrofit(Lq0/a0;)Lt0/w;

    move-result-object v1

    iput-object v1, p0, Lcom/pubnub/api/managers/RetrofitManager;->noSignatureInstance:Lt0/w;

    .line 28
    const-class v2, Lcom/pubnub/api/services/PresenceService;

    invoke-virtual {p1, v2}, Lt0/w;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lt0/w;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v0}, Lt0/w;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1}, Lt0/w;->b(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private closeExecutor(Lq0/a0;Z)V
    .locals 3

    .line 1
    iget-object v0, p1, Lq0/a0;->x:Lq0/q;
    ...
    .line 3
    :try_start_0
    iget-object v1, v0, Lq0/q;->c:Ljava/util/ArrayDeque;
    ...
    check-cast v2, Lq0/h0/g/e$a;

    .line 4
    iget-object v2, v2, Lq0/h0/g/e$a;->q:Lq0/h0/g/e;

    .line 5
    invoke-virtual {v2}, Lq0/h0/g/e;->cancel()V

    goto :goto_0

    .line 6
    :cond_0
    iget-object v1, v0, Lq0/q;->d:Ljava/util/ArrayDeque;
    ...
    .line 14
    iget-object v0, p2, Lq0/h0/g/h;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 18
    :try_start_1
    iget-object v2, v1, Lq0/h0/g/g;->o:Ljava/util/List;
    ...
    .line 21
    iput-boolean v2, v1, Lq0/h0/g/g;->i:Z

    .line 22
    iget-object v2, v1, Lq0/h0/g/g;->c:Ljava/net/Socket;
    ...
    iget-object p2, p2, Lq0/h0/g/h;->b:Lq0/h0/f/c;

    invoke-virtual {p2}, Lq0/h0/f/c;->a()V

    .line 27
    :cond_6
    iget-object p1, p1, Lq0/a0;->x:Lq0/q;

    .line 28
    invoke-virtual {p1}, Lq0/q;->a()Ljava/util/concurrent/ExecutorService;
...
.method private createOkHttpClient(Lq0/a0$a;)Lq0/a0;
    .locals 3
    ...
    .line 4
    iget-object p1, v0, Lq0/a0;->x:Lq0/q;
    ...
    .line 12
    invoke-static {p1, v1}, Li0/d/a/a/a;->e0(Ljava/lang/String;I)Ljava/lang/String;
...
.method private createRetrofit(Lq0/a0;)Lt0/w;
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Lcom/pubnub/api/managers/RetrofitManager;->createRetrofit(Lq0/a0;Ljava/lang/String;)Lt0/w;
...
.method private createRetrofit(Lq0/a0;Ljava/lang/String;)Lt0/w;
    .locals 3

    .line 2
    new-instance v0, Lt0/w$b;

    invoke-direct {v0}, Lt0/w$b;-><init>()V
    ...
    .line 5
    iput-object v1, v0, Lt0/w$b;->b:Lq0/f$a;

    .line 6
    :cond_0
    invoke-virtual {v0, p2}, Lt0/w$b;->b(Ljava/lang/String;)Lt0/w$b;
    ...
    invoke-virtual {p2}, Lcom/pubnub/api/managers/MapperManager;->getConverterFactory()Lt0/h$a;

    move-result-object p2

    invoke-virtual {v0, p2}, Lt0/w$b;->a(Lt0/h$a;)Lt0/w$b;
    ...
    .line 9
    invoke-virtual {v0, p1}, Lt0/w$b;->d(Lq0/a0;)Lt0/w$b;

    .line 10
    :cond_1
    invoke-virtual {v0}, Lt0/w$b;->c()Lt0/w;
...
.method private prepareOkHttpClient(II)Lq0/a0$a;
    .locals 6
    ...
    .line 5
    invoke-static {v5, v2, v3, p1}, Lq0/h0/c;->b(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I
    ...
    .line 13
    invoke-virtual {v1, p1}, Lq0/a0$a;->a(Lq0/x;)Lq0/a0$a;
    ...
    .line 20
    iget-object v4, v1, Lq0/a0$a;->q:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iget-object v4, v1, Lq0/a0$a;->r:Ljavax/net/ssl/X509TrustManager;
    ...
    .line 21
    :cond_2
    iput-object p2, v1, Lq0/a0$a;->D:Lq0/h0/g/i;

    .line 22
    :cond_3
    iput-object p1, v1, Lq0/a0$a;->q:Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 26
    invoke-virtual {p1, v2}, Lq0/h0/l/h;->b(Ljavax/net/ssl/X509TrustManager;)Lq0/h0/n/c;

    move-result-object p1

    .line 27
    iput-object p1, v1, Lq0/a0$a;->w:Lq0/h0/n/c;
    ...
    .line 29
    :cond_4
    invoke-virtual {v0}, Lcom/pubnub/api/PNConfiguration;->getConnectionSpec()Lq0/m;
    ...
    .line 32
    iget-object v2, v1, Lq0/a0$a;->s:Ljava/util/List;
    ...
    iput-object p1, v1, Lq0/a0$a;->s:Ljava/util/List;
    ...
    .line 38
    iget-object v0, v1, Lq0/a0$a;->u:Ljavax/net/ssl/HostnameVerifier;
    ...
    .line 40
    :cond_7
    iput-object p1, v1, Lq0/a0$a;->u:Ljavax/net/ssl/HostnameVerifier;
    ...
    .line 43
    iget-object v0, v1, Lq0/a0$a;->m:Ljava/net/Proxy;
    ...
    .line 45
    :cond_9
    iput-object p1, v1, Lq0/a0$a;->m:Ljava/net/Proxy;
    ...
    .line 49
    iget-object v0, v1, Lq0/a0$a;->n:Ljava/net/ProxySelector;
    ...
    .line 51
    :cond_b
    iput-object p1, v1, Lq0/a0$a;->n:Ljava/net/ProxySelector;
    ...
    invoke-virtual {p1}, Lcom/pubnub/api/PNConfiguration;->getProxyAuthenticator()Lq0/c;
    ...
    .line 55
    iget-object v0, v1, Lq0/a0$a;->o:Lq0/c;
    ...
    .line 57
    :cond_d
    iput-object p1, v1, Lq0/a0$a;->o:Lq0/c;
    ...
    invoke-virtual {p1}, Lcom/pubnub/api/PNConfiguration;->getCertificatePinner()Lq0/h;
    ...
    .line 61
    iget-object v0, v1, Lq0/a0$a;->v:Lq0/h;
    ...
    .line 63
    :cond_f
    iput-object p1, v1, Lq0/a0$a;->v:Lq0/h;
...
.method public destroy(Z)V
    ...
    .line 1
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->transactionClientInstance:Lq0/a0;

    if-eqz v0, :cond_0

    .line 2
    invoke-direct {p0, v0, p1}, Lcom/pubnub/api/managers/RetrofitManager;->closeExecutor(Lq0/a0;Z)V
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->noSignatureClientInstance:Lq0/a0;
...
.method public getNoSignatureInstance()Lt0/w;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->noSignatureInstance:Lt0/w;
...
.method public getSubscriptionInstance()Lt0/w;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->subscriptionInstance:Lt0/w;
...
.method public getTransactionClientExecutorService()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    invoke-virtual {v0}, Lq0/q;->a()Ljava/util/concurrent/ExecutorService;
...
.method public getTransactionInstance()Lt0/w;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/pubnub/api/managers/RetrofitManager;->transactionInstance:Lt0/w;
