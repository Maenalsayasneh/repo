...
# instance fields
.field public c:Lcom/instabug/survey/ui/f;


# direct methods
.method public constructor <init>(Li0/j/f/s/b;)V
    .locals 0
...
# virtual methods
.method public k(Lcom/instabug/survey/models/Survey;)V
    .locals 6
    ...
    .line 6
    iget-object v3, v3, Li0/j/f/o/b;->b:Landroid/content/SharedPreferences;
    ...
    .line 16
    iget-object v4, v4, Lcom/instabug/survey/models/b;->y:Ljava/lang/String;
    ...
    :cond_8
    :goto_4
    invoke-virtual {p0, p1, v3}, Li0/j/f/s/d;->l(Lcom/instabug/survey/models/Survey;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2, v3}, Li0/j/f/o/b;->a(J)V
    ...
    .line 25
    invoke-interface {p1}, Li0/j/f/s/b;->b()Landroid/content/Intent;
    ...
    .line 27
    invoke-interface {p1, v1}, Li0/j/f/s/b;->L(Z)V

    :cond_a
    return-void
.end method

.method public final l(Lcom/instabug/survey/models/Survey;Ljava/lang/String;)V
    .locals 3
    ...
    .line 2
    iget-object v0, v0, Li0/j/f/o/a;->f:Lcom/instabug/survey/callbacks/OnFinishCallback;
    ...
    .line 4
    invoke-static {p1, p2}, Li0/j/e/c1/b;->e(Lcom/instabug/survey/models/Survey;Ljava/lang/String;)Lorg/json/JSONObject;
...
.method public m(Lcom/instabug/survey/ui/f;Z)V
    .locals 2

    .line 1
    iput-object p1, p0, Li0/j/f/s/d;->c:Lcom/instabug/survey/ui/f;
    ...
    check-cast v1, Lh0/o/a/k;

    if-eqz v1, :cond_1

    .line 6
    invoke-static {v1, p1}, Li0/j/e/c1/b;->a(Landroid/app/Activity;Lcom/instabug/survey/ui/f;)I
    ...
    .line 7
    invoke-interface {v0, p1}, Li0/j/f/s/b;->e(I)V

    goto :goto_0

    .line 8
    :cond_0
    invoke-interface {v0, p1}, Li0/j/f/s/b;->k(I)V
