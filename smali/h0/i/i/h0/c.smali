...
.method public constructor <init>(Landroid/view/inputmethod/InputConnection;ZLh0/i/i/h0/d;)V
    ...
    .line 1
    iput-object p3, p0, Lh0/i/i/h0/c;->a:Lh0/i/i/h0/d;
...
.method public performPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 1
    iget-object v0, p0, Lh0/i/i/h0/c;->a:Lh0/i/i/h0/d;
    ...
    .line 11
    new-instance v12, Lh0/i/i/h0/e$a;

    invoke-direct {v12, v6, v7, v8}, Lh0/i/i/h0/e$a;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    goto :goto_7

    .line 12
    :cond_8
    new-instance v12, Lh0/i/i/h0/e$b;

    invoke-direct {v12, v6, v7, v8}, Lh0/i/i/h0/e$b;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V
    ...
    .line 14
    :try_start_2
    invoke-interface {v12}, Lh0/i/i/h0/e$c;->b()V
    :try_end_2
    ...
    .line 15
    :try_start_3
    invoke-interface {v12}, Lh0/i/i/h0/e$c;->d()Ljava/lang/Object;
    ...
    .line 21
    invoke-interface {v12}, Lh0/i/i/h0/e$c;->getDescription()Landroid/content/ClipDescription;
    ...
    .line 23
    invoke-interface {v12}, Lh0/i/i/h0/e$c;->a()Landroid/net/Uri;
    ...
    .line 25
    new-instance v7, Lh0/i/i/c$a;

    const/4 v8, 0x2

    invoke-direct {v7, v6, v8}, Lh0/i/i/c$a;-><init>(Landroid/content/ClipData;I)V

    .line 26
    invoke-interface {v12}, Lh0/i/i/h0/e$c;->c()Landroid/net/Uri;

    move-result-object v6

    .line 27
    iput-object v6, v7, Lh0/i/i/c$a;->d:Landroid/net/Uri;

    .line 28
    iput-object v3, v7, Lh0/i/i/c$a;->e:Landroid/os/Bundle;

    .line 29
    new-instance v3, Lh0/i/i/c;

    invoke-direct {v3, v7}, Lh0/i/i/c;-><init>(Lh0/i/i/c$a;)V

    .line 30
    iget-object v0, v0, Lh0/b/f/r;->a:Landroid/view/View;

    invoke-static {v0, v3}, Lh0/i/i/q;->l(Landroid/view/View;Lh0/i/i/c;)Lh0/i/i/c;
